...
public class ResponseFightResultPacket extends Packet {
    ...
    @Trash(length = 10) private List<FightTotalKill> kill = new ArrayList<>();
    @Trash(length = 10) private List<FightTotalExp> exp = new ArrayList<>();
    @Trash(length = 10) private List<FightRobResource> prize = new ArrayList<>();
