...
// Clase DTO para representar datos del último planeta
public class LastPlanetDTO {

    // Campos de coordenadas
    private int x; // Coordenada X del planeta
    private int y; // Coordenada Y del planeta

    // Campo de identificación
    private long id; // ID único del planeta
