...
// Clase que representa un trigger para el inicio de la acción de un equipo de naves en batalla
public class StartTrigger extends BattleActionTrigger { // Extiende BattleActionTrigger

    // Campo privado que almacena el ID del equipo de naves que inicia su acción
    private int shipTeamId; // ID del equipo de naves involucrado en el trigger de inicio
