...
// Clase que representa un trigger para el final de la acción de un fuerte en batalla
public class EndFortTrigger extends BattleActionTrigger { // Extiende BattleActionTrigger

    // Campo privado que almacena el ID del fuerte que termina su acción
    private int fortId; // ID del fuerte involucrado en el trigger de fin
