...
// Clase que representa las recompensas de un usuario
public class UserRewards {

    private int level; // Nivel de recompensas
    private Date until; // Fecha hasta la que están disponibles las recompensas
