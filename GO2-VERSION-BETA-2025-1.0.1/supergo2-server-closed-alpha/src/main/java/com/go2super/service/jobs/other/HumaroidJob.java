        ...
        if(toUpdate.size() > 0) {
            ...
            JobService.submit(() -> {
                ...
                for(Planet planet : toUpdatePlanets) {
                    ...
                    if(planet == null || planet.getType() != PlanetType.HUMAROID_PLANET) continue;
                    ...
                    if(humaroidPlanet.getStatusTime().before(DateUtil.now())) {
                        ...
                        if(humaroidPlanet.hasFight()) continue;
