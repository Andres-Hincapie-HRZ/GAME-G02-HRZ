...
public class MuteCommand extends Command {
    ...
    public void execute(User user, Account account, SmartServer smartServer, String label, String[] parts) {
        ...
        ChatService.getInstance().medusaMessage("The user [" + toUser.getUsername() + "] has been silenced for " + parsed + " seconds!");
        ...
        if(gameUserOptional.isPresent()) gameUserOptional.get().getSmartServer().send(response);
