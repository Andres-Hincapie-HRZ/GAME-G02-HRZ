...
public class ChatGameJob implements OfflineJob {
    ...
    private static String comm = "abcdefghijklmnopqrstuvwxyz";

    private static List<PrizeWeight> prizes;
    ...
    public void congratulate(User user) {
        ...
        if(gameUserOptional.isPresent()) gameUserOptional.get().getSmartServer().send(packet);
    ...
    public static ChatGameJob getInstance() {
        if(instance == null) instance = new ChatGameJob();
        return instance;
    }
