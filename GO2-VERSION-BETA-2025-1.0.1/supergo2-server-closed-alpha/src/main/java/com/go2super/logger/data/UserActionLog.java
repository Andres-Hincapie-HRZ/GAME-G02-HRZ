...
public class UserActionLog extends Action {
    ...
    @JsonProperty("account_email") private String accountEmail;
    @JsonProperty("optional_discord_id") private String optionalDiscordId;

    @JsonProperty("action") private String action;

    @JsonProperty("before_data") private Object beforeData;
    @JsonProperty("after_data") private Object afterData;
