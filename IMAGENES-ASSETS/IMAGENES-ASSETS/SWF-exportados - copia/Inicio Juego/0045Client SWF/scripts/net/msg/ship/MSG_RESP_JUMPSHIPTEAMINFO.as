package net.msg.ship
{
   ...
   public class MSG_RESP_JUMPSHIPTEAMINFO extends MsgHead
   {
      ...
      public function MSG_RESP_JUMPSHIPTEAMINFO()
      {
         ...
         while(_loc1_ < 15)
         {
            _loc2_ = new MSG_RESP_JUMPSHIPTEAMINFO_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_JUMPSHIPTEAMINFO;
      }
