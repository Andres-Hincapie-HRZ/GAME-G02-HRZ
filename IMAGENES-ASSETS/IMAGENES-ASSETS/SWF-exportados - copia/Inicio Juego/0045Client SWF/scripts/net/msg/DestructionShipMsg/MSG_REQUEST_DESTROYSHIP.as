package net.msg.DestructionShipMsg
{
   ...
   public class MSG_REQUEST_DESTROYSHIP extends MsgHead
   {
      ...
      public function MSG_REQUEST_DESTROYSHIP()
      {
         ...
         usType = MsgTypes._MSG_REQUEST_DESTROYSHIP;
      }
