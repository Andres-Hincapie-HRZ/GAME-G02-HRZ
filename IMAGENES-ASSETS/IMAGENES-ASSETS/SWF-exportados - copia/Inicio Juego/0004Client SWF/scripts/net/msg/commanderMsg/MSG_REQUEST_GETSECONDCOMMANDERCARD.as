package net.msg.commanderMsg
{
   ...
   public class MSG_REQUEST_GETSECONDCOMMANDERCARD extends MsgHead
   {
      ...
      public function MSG_REQUEST_GETSECONDCOMMANDERCARD()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_GETSECONDCOMMANDERCARD;
      }
