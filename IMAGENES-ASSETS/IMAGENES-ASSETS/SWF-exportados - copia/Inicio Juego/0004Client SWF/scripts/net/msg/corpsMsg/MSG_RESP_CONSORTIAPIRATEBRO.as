package net.msg.corpsMsg
{
   ...
   public class MSG_RESP_CONSORTIAPIRATEBRO extends MsgHead
   {
      ...
      public function MSG_RESP_CONSORTIAPIRATEBRO()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_CONSORTIAPIRATEBRO;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.Flag = _loc2_.readInt(param1);
