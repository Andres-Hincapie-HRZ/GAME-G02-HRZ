package net.msg.commanderMsg
{
   ...
   public class MSG_RESP_COMMANDEREDITSHIPTEAM extends MsgHead
   {
      ...
      public function MSG_RESP_COMMANDEREDITSHIPTEAM()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_COMMANDEREDITSHIPTEAM;
      }
