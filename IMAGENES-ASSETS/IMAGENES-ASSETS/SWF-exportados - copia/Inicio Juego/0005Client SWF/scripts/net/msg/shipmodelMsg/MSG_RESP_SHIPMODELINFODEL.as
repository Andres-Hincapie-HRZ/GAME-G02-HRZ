package net.msg.shipmodelMsg
{
   ...
   public class MSG_RESP_SHIPMODELINFODEL extends MsgHead
   {
      ...
      public function MSG_RESP_SHIPMODELINFODEL()
      {
         ...
         usType = MsgTypes._MSG_RESP_SHIPMODELINFODEL;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.DataLen = _loc2_.readUnsignShort(param1);
         var _loc3_:int = 0;
         while(_loc3_ < 7)
         {
