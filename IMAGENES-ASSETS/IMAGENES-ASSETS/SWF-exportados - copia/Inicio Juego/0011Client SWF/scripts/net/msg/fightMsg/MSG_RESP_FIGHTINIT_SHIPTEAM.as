package net.msg.fightMsg
{
   ...
   public class MSG_RESP_FIGHTINIT_SHIPTEAM extends MsgHead
   {
      ...
      public function MSG_RESP_FIGHTINIT_SHIPTEAM()
      {
         var _loc2_:MSG_RESP_FIGHTINIT_SHIPTEAM_TEMP = null;
         this.Data = new Array(2);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 2)
         {
            _loc2_ = new MSG_RESP_FIGHTINIT_SHIPTEAM_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_FIGHTINIT_SHIPTEAM;
      }
