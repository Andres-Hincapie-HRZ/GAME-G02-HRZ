package net.msg.commanderMsg
{
   ...
   public class MSG_REQUEST_COMMANDERCHANGECARD extends MsgHead
   {
      ...
      public function MSG_REQUEST_COMMANDERCHANGECARD()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_COMMANDERCHANGECARD;
      }
