package net.msg.commanderMsg
{
   ...
   public class MSG_REQUEST_COMMANDERINFO extends MsgHead
   {
      ...
      public function MSG_REQUEST_COMMANDERINFO()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_COMMANDERINFO;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.ShowType = _loc2_.readInt(param1);
         _loc2_ = null;
      }
      ...
      public function writeBuf(param1:ByteArray) : void
      {
         ...
         _loc2_.writeInt(param1,this.ShowType);
