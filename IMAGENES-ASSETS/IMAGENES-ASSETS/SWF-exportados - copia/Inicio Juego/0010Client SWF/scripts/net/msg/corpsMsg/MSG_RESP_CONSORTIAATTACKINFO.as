package net.msg.corpsMsg
{
   ...
   public class MSG_RESP_CONSORTIAATTACKINFO extends MsgHead
   {
      ...
      public function MSG_RESP_CONSORTIAATTACKINFO()
      {
         var _loc2_:MSG_RESP_CONSORTIAATTACKINFO_TEMP = null;
         this.Data = new Array(6);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 6)
         {
            _loc2_ = new MSG_RESP_CONSORTIAATTACKINFO_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_CONSORTIAATTACKINFO;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.AttackCount = _loc2_.readShort(param1);
