   ...
   public class MapRouter
   {
      ...
      public function resp_MSG_RESP_GALAXYSHIP(param1:int, param2:int, param3:ByteArray) : void
      {
         ...
         while(_loc5_ < _loc4_.DataLen)
         {
            ...
            ExternalInterface.call("console.log","[#] GSHIP shipTeamId => " + _loc7_.ShipTeamId);
            ...
            ExternalInterface.call("console.log","[#] GSHIP rendering => ()");
            GalaxyShipManager.instance.renderOneShipTeam(_loc7_);
            ExternalInterface.call("console.log","[#] GSHIP rendered => ()");
            _loc5_++;
            ExternalInterface.call("console.log","[#] GSHIP rendered => (NEXT) " + _loc5_);
         }
      }
