package net.router
{
   ...
   public class CorpsRouter
   {
      ...
      {
         ExternalInterface.call("console.log","[#] ConsortiaInfo => " + param1 + ", " + param2);
      ...
      {
         ExternalInterface.call("console.log","[#] Here param1 => " + param1);
         ExternalInterface.call("console.log","[#] Here param2 => " + param2);
