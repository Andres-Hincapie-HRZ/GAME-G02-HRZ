package logic.ui
{
   ...
   public class FieldUI extends AbstractPopUp
   {
      ...
      private function ShowFieldTip(param1:int, param2:MovieClip) : void
      {
         ...
         _loc4_ = this.FieldMsg.Data[param1];
         if(_loc4_.Status == 1)
         {
      ...
      {
         var _loc4_:MSG_RESP_FIELDRESOURCE_TEMP = null;
         var _loc5_:MSG_REQUEST_GROWFIELDRESOURCE = null;
         if(this.FieldMsg == null)
         {
            return;
         }
         ...
         _loc5_ = new MSG_REQUEST_GROWFIELDRESOURCE();
      ...
      {
         var _loc4_:MSG_REQUEST_DELETEFIELDRESOURCE = null;
         ...
         _loc4_ = new MSG_REQUEST_DELETEFIELDRESOURCE();
