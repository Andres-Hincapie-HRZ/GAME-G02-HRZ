package net.msg.corpsMsg
{
   ...
   public class MSG_RESP_CONSORTIAEVENT extends MsgHead
   {
      ...
      public function MSG_RESP_CONSORTIAEVENT()
      {
         var _loc2_:MSG_RESP_CONSORTIAEVENT_TEMP = null;
         this.Data = new Array(9);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 9)
         {
            _loc2_ = new MSG_RESP_CONSORTIAEVENT_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_CONSORTIAEVENT;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.EventCount = _loc2_.readShort(param1);
