package net.msg.sciencesystem
{
   ...
   public class MSG_REQUEST_UNBINDCOMMANDERCARD extends MsgHead
   {
      ...
      public function MSG_REQUEST_UNBINDCOMMANDERCARD()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_UNBINDCOMMANDERCARD;
      }
