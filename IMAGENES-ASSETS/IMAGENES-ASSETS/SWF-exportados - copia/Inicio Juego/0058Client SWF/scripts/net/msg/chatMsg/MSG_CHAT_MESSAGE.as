package net.msg.chatMsg
{
   ...
   public class MSG_CHAT_MESSAGE extends MsgHead
   {
      ...
      public function MSG_CHAT_MESSAGE()
      {
         ...
         usType = MsgTypes._MSG_CHAT_MESSAGE;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.corp = _loc2_.readWideChar(param1,64);
         this.acronym = _loc2_.readInt(param1);
         this.rank = _loc2_.readInt(param1);
      ...
      public function writeBuf(param1:ByteArray) : void
      {
         ...
         _loc2_.writeWideChar(param1,"",64);
      ...
      {
         param1 = 4;
         return int(param1 + (40 + 128 + 256 + 2 + 4 + 8 + 128));
      }
