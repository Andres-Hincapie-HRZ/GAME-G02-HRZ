package net.router
{
   ...
   import net.msg.MSG_RESP_CUSTOM_WARSCORE;
   ...
   public class CustomRouter
   {
      ...
      public function Resp_MSG_RESP_CUSTOM_WARSCORE(param1:int, param2:int, param3:ByteArray) : void
      {
         var _loc4_:MSG_RESP_CUSTOM_WARSCORE = new MSG_RESP_CUSTOM_WARSCORE();
         NetManager.Instance().readObject(_loc4_,param3);
         GamePlayer.getInstance().WarScoreExchange = _loc4_.WarScoreExchange;
      }
