package logic.ui
{
   ...
   import logic.entry.Rank.CorpsRankInfo;
   import logic.entry.Rank.RankFightInfo;
   import logic.entry.Rank.RankUserInfo;
   ...
   public class RankingSceneUI extends AbstractPopUp
   {
      ...
      private function showHoldGalaxy(param1:MouseEvent) : void
      {
         ...
         _loc8_ = param1.currentTarget as TextField;
