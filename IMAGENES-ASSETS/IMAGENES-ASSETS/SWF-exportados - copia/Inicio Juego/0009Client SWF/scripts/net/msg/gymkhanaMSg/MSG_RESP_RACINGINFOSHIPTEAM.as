package net.msg.gymkhanaMSg
{
   ...
   public class MSG_RESP_RACINGINFOSHIPTEAM extends MsgHead
   {
      ...
      public function MSG_RESP_RACINGINFOSHIPTEAM()
      {
         var _loc2_:MSG_RESP_RACINGINFOSHIPTEAM_TEMP = null;
         this.Data = new Array(20);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 20)
         {
            _loc2_ = new MSG_RESP_RACINGINFOSHIPTEAM_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_RACINGINFOSHIPTEAM;
      }
