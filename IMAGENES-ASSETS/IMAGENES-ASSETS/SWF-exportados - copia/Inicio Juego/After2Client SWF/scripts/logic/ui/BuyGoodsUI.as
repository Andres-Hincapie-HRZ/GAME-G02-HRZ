package logic.ui
{
   ...
   public class BuyGoodsUI extends AbstractPopUp
   {
      ...
      private function InitMallgoodsPopup() : void
      {
         ...
         var _loc3_:MovieClip = this.MallgoodsPopupMc.getChildByName("mc_honor2") as MovieClip;
         _loc3_.visible = false;
         var _loc4_:MovieClip = this.MallgoodsPopupMc.getChildByName("mc_honor3") as MovieClip;
         _loc4_.visible = false;
         this.ParentLock.fillRectangleWithoutBorder(0,0,GameSetting.GAME_STAGE_WIDTH,GameSetting.GAME_STAGE_HEIGHT,0,0);
