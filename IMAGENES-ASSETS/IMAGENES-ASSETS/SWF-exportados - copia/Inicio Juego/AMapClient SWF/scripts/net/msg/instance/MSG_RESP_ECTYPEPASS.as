package net.msg.instance
{
   ...
   public class MSG_RESP_ECTYPEPASS extends MsgHead
   {
      
      public var DataLen:int;
      
      public var Data:Array = new Array(50);
      
      public function MSG_RESP_ECTYPEPASS()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_ECTYPEPASS;
      }
