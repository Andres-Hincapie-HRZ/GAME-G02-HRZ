package logic.ui
{
   ...
   public class ComposeUI extends AbstractPopUp
   {
      ...
      private var HasMultiDiamond:Boolean;
      
      private var SelectedItem:MovieClip;
      
      private var btn_class3:HButton;
      
      private var btn_class4:HButton;
      ...
      override public function initMcElement() : void
      {
         ...
         _loc2_ = this._mc.getMC().getChildByName("btn_heti") as MovieClip;
         this.btn_heti = new HButton(_loc2_,HButtonType.SIMPLE,false,StringManager.getInstance().getMessageString("Boss191"));
         _loc2_.addEventListener(MouseEvent.CLICK,this.btn_hetiClick);
         ComposeUI_SixGod.GetInstance().Init(this._mc.getMC());
         _loc3_ = this._mc.getMC().getChildByName("btn_qijianmerge");
         this.HasChip = _loc3_ != null;
         if(this.HasChip)
         {
         ...
         _loc3_ = this._mc.getMC().getChildByName("btn_class3");
         this.HasMultiDiamond = _loc3_ != null;
         if(this.HasMultiDiamond)
         {
            _loc2_ = _loc3_ as MovieClip;
            this.btn_class3 = new HButton(_loc2_,HButtonType.SIMPLE,false,StringManager.getInstance().getMessageString("Boss123"));
            _loc2_.addEventListener(MouseEvent.CLICK,this.btn_class3Click);
         }
         ...
         var _loc4_:MovieClip = this._mc.getMC().getChildByName("mc_qijianmerge") as MovieClip;
         if(this.HasChip)
         {
         ...
         if(this.HasMultiDiamond)
         {
            ComposeUI_MultiDiamond.GetInstance().Init(this._mc.getMC());
         }
      }
      ...
      private function SetPanleVisible(param1:Boolean, param2:Boolean, param3:Boolean, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false, param8:* = false) : void
      {
         ...
         this._mc.getMC().mc_energe.visible = param8;
         if(this.HasChip)
         {
         ...
         this._mc.getMC().mc_mergegem.visible = param7;
      }
      
      private function btn_hetiClick(param1:MouseEvent) : void
      {
         this.SetPanleVisible(false,false,false,false,false,false,false,true);
         this.ResetSelectedBtn(this.btn_heti);
         ComposeUI_SixGod.GetInstance().Clear();
      ...
      private function btn_class3Click(param1:MouseEvent) : void
      {
         this.SetPanleVisible(false,false,false,false,false,false,true);
         this.ResetSelectedBtn(this.btn_class3);
         ComposeUI_MultiDiamond.GetInstance().Clear();
         this.btn_help.setVisible(false);
         this.CloseHelp(null);
      }
