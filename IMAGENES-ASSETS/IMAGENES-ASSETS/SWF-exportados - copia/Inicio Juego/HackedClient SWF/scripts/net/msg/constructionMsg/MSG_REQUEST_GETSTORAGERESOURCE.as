package net.msg.constructionMsg
{
   ...
   public class MSG_REQUEST_GETSTORAGERESOURCE extends MsgHead
   {
      ...
      public function MSG_REQUEST_GETSTORAGERESOURCE()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_GETSTORAGERESOURCE;
      }
