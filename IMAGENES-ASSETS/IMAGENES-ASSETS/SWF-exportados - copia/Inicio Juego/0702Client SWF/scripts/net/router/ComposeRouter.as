package net.router
{
   ...
   import logic.ui.ComposeUI_MultiDiamond;
   import logic.ui.ComposeUI_SixGod;
   ...
   public class ComposeRouter
   {
      ...
      public function Resp_MSG_RESP_COMMANDERPROPERTYSTONE(param1:int, param2:int, param3:ByteArray) : void
      {
         var _loc5_:DiamondInfo = null;
         var _loc6_:* = null;
         var _loc4_:MSG_RESP_COMMANDERPROPERTYSTONE = new MSG_RESP_COMMANDERPROPERTYSTONE();
         NetManager.Instance().readObject(_loc4_,param3);
         if(_loc4_.BroFlag == 1)
         {
            _loc5_ = CPropsReader.getInstance().GetDiamond(_loc4_.ObjStoneId);
            _loc6_ = "<a href=\"event:" + _loc4_.Guid + "," + _loc4_.Name + "\">[" + _loc4_.Name + "]</a>  " + StringManager.getInstance().getMessageString("CorpsText146");
            if(_loc5_.GemLevel == 3)
            {
               _loc6_ += "<font color=\'#0090F8\'>";
         ...
         if(_loc4_.Guid == GamePlayer.getInstance().Guid)
         {
            ComposeUI_MultiDiamond.GetInstance().Resp_MSG_RESP_COMMANDERPROPERTYSTONE(_loc4_);
         }
      }
      ...
      public function resp_MSG_RESP_UNIONSHIPPROPS(param1:int, param2:int, param3:ByteArray) : void
      {
         var _loc4_:MSG_RESP_UNIONSHIPPROPS = new MSG_RESP_UNIONSHIPPROPS();
         NetManager.Instance().readObject(_loc4_,param3);
         ComposeUI_SixGod.GetInstance().Resp_MSG_RESP_UNIONSHIPPROPS(_loc4_);
      }
