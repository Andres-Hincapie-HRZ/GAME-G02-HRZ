package logic.ui
{
   ...
   public class PlayerInfoUI
   {
      ...
      public function bindPlayerImage() : void
      {
         ...
         if(GameKernel.youselfFaceBook)
         {
            _loc1_ = new ImageLoader();
            _loc1_.LoadImage(GameKernel.youselfFaceBook.pic_square,this.mc_base,this.playerCallBack,GameKernel.ForRenRen == 1);
         }
         else
         {
            _loc1_ = new ImageLoader();
            _loc1_.LoadImage(CustomRouter.instance.userImage,this.mc_base,this.playerCallBack,GameKernel.ForRenRen == 1);
         }
      }
      ...
      public function bindFriendImage(param1:Number) : void
      {
         ...
         else
         {
            ...
            else if(CustomRouter.instance.otherImages.ContainsKey(param1))
            {
               _loc4_ = new ImageLoader();
               _loc4_.LoadImage(CustomRouter.instance.otherImages.Get(param1),this.mc_base,this.playerCallBack,GameKernel.ForRenRen == 1);
            }
            if(_loc2_)
            {
      ...
      private function playerCallBack(param1:MovieClip, param2:DisplayObject) : void
      {
         ...
         else
         {
            ...
            this._prePlayImage.width = 50;
            this._prePlayImage.height = 50;
            GameKernel.facebookFriendImage.Put(CustomRouter.instance.userId,this._prePlayImage);
            param1.addChild(this._prePlayImage);
         }
      }
