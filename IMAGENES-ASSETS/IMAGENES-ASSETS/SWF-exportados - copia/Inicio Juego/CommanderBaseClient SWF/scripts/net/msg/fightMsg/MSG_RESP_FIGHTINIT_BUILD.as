package net.msg.fightMsg
{
   ...
   public class MSG_RESP_FIGHTINIT_BUILD extends MsgHead
   {
      
      public static var MAX_INITBUILDNUM:int = 80;
      ...
      public function MSG_RESP_FIGHTINIT_BUILD()
      {
         var _loc2_:MSG_RESP_FIGHTINIT_BUILD_TEMP = null;
         this.Data = new Array(MAX_INITBUILDNUM);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < MAX_INITBUILDNUM)
         {
            _loc2_ = new MSG_RESP_FIGHTINIT_BUILD_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_FIGHTINIT_BUILD;
         this.DataLen = 0;
      }
      ...
      {
         var _loc1_:int = MAX_INITBUILDNUM - 1;
         while(_loc1_ >= 0)
         {
