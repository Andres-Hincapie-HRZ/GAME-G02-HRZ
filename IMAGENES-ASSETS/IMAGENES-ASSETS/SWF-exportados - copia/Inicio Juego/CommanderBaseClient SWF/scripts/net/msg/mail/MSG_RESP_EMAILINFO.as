package net.msg.mail
{
   ...
   public class MSG_RESP_EMAILINFO extends MsgHead
   {
      ...
      public function MSG_RESP_EMAILINFO()
      {
         ...
         while(_loc1_ < 9)
         {
            _loc2_ = new MSG_RESP_EMAILINFO_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_EMAILINFO;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.EmailCount = _loc2_.readShort(param1);
         var _loc3_:int = 0;
         while(_loc3_ < 9)
         {
