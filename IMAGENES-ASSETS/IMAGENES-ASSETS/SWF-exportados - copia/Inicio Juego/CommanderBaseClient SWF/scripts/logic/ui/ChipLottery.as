package logic.ui
{
   ...
   public class ChipLottery extends AbstractPopUp
   {
      ...
      {
         var _loc2_:int = GamePlayer.getInstance().cash / 50;
         var _loc3_:int = this.ChipInfoMsg.CmosPackCount - this.ChipInfoMsg.DataLen;
         if(_loc3_ < _loc2_)
         {
            _loc2_ = _loc3_;
         }
         FleetNumUI.getInstance().Show(this._mc.getMC(),_loc2_,this.BuyExp2,StringManager.getInstance().getMessageString("Boss195"),true,1);
      }
      
      private function BuyExp2(param1:int) : void
      {
         var _loc3_:MSG_REQUEST_BUYGOODS = null;
         var _loc2_:int = 0;
         while(_loc2_ < param1)
         {
            _loc3_ = new MSG_REQUEST_BUYGOODS();
            _loc3_.PropsId = 4221;
            _loc3_.Num = 1;
            _loc3_.Type = 0;
