package logic.game
{
   ...
   public class GameKernel extends Container
   {
      ...
      private var isQuality:Boolean = true;
      
      public var isCommanderInit:Boolean = false;
      ...
      public static function postMessageToFaceBook(param1:String, param2:Function = null) : void
      {
         FacebookClient.PublishStream(param1,param2);
      }
      
      public static function getAppFriendsList(param1:Function) : void
      {
         FacebookClient.GetAppFriends(param1);
      }
      ...
      public static function getMovieClipInstance(param1:String, param2:int = 0, param3:int = 0, param4:Boolean = false) : MovieClip
      {
         ...
         var _loc5_:* = Class(getDefinitionByName(param1));
         if(_loc5_)
         {
            _loc6_ = new _loc5_();
            _loc6_.name = param1;
      ...
      private function Init(param1:Event) : void
      {
         ...
         GameKernel.ForJS = GameKernel.flashVar["ForJS"];
         GameKernel.platform2 = parseInt(GameKernel.flashVar["platform"]);
         GameKernel.ForFB = GameKernel.flashVar["ForFB"];
         GameKernel.ForRenRen = GameKernel.flashVar["ForRenRen"];
         ...
         else if(GameSetting.DEBUG_NATIVE)
         {
            if(GameKernel.flashVar["SessionKey"] == undefined)
            {
               ...
               while(_loc3_ < 10)
               {
                  ...
                  _loc4_.pic_square = "https://graph.facebook.com/100000556404329/picture?type=square";
      ...
      public function initFacebookLoginUserInfo(param1:FacebookUserInfo) : void
      {
         ...
         else if(GameSetting.DEBUG_NATIVE)
         {
            if(GameKernel.flashVar["SessionKey"] == undefined)
            {
               ...
               youselfFaceBook.pic_square = "https://graph.facebook.com/100000556404329/picture?type=square";
            }
         }
         ++this.count;
         this.checkFacebook();
