package logic.ui
{
   ...
   public class ShipTransferUI extends AbstractPopUp
   {
      ...
      private function onDoubleClick(param1:MouseEvent) : void
      {
         ...
         _loc4_ = this._shipTeams.Values()[_loc2_ + this.selCurPage * this.selPageSize];
         var _loc8_:int = 0;
         ...
         if(_loc3_.selsected)
         {
            ...
            {
               _loc9_ = StringManager.getInstance().getMessageString("BattleTXT10");
               _loc10_ = GameKernel.renderManager.getUI().getContainer();
               CEffectText.getInstance().showEffectText(_loc10_,_loc9_);
      ...
      private function freshItem() : void
      {
         ...
         while(_loc2_ < this.selPageSize)
         {
            ...
            _loc3_ = this._shipTeams.Values()[this.selCurPage * this.selPageSize + _loc2_];
            if(_loc3_)
            {
      ...
      public function RequestJumpShips(param1:int, param2:int, param3:int = 0, param4:int = -1) : void
      {
         var _loc5_:MSG_REQUEST_JUMPGALAXYSHIP = new MSG_REQUEST_JUMPGALAXYSHIP();
         _loc5_.SeqId = GamePlayer.getInstance().seqID++;
         _loc5_.Guid = GamePlayer.getInstance().Guid;
         _loc5_.Type = param3;
         _loc5_.GalaxyMapId = param2;
         _loc5_.GalaxyId = param1;
         NetManager.Instance().sendObject(_loc5_);
