package logic.ui
{
   ...
   public class ResPlaneUI
   {
      ...
      {
         this.tf_metal.text = StringUitl.toUSFormat(GamePlayer.getInstance().UserMetal);
         this.tf_He3.text = StringUitl.toUSFormat(GamePlayer.getInstance().UserHe3);
         this.tf_fund.text = StringUitl.toUSFormat(GamePlayer.getInstance().UserMoney);
         this.tf_cash.text = StringUitl.toUSFormat(GamePlayer.getInstance().cash);
         this.updateDropPlaneResource();
      }
