package logic.ui
{
   ...
   public class PlayerInfoPopUp extends AbstractPopUp
   {
      ...
      private function btn_explainOver(param1:MouseEvent) : void
      {
         ...
         if(GalaxyMapAction.instance.curStar.Type == GalaxyType.GT_2)
         {
            _loc2_ = "Boss67";
         }
      ...
      public function setPlayerInfo() : void
      {
         ...
         {
            this.btn_explain.setVisible(GalaxyMapAction.instance.curStar.Type == GalaxyType.GT_2 || GalaxyMapAction.instance.curStar.Type == GalaxyType.GT_3);
         }
         else
         {
         ...
         if(ChatAction.getInstance()._SenderType == 0 && GalaxyMapAction.instance.curStar.Type == GalaxyType.GT_2)
         {
         ...
         {
            this._UserInfo = null;
            GameKernel.getPlayerFacebookInfo(ChatAction.currentPlayer.UserId,this.getPlayerFacebookInfoCallback,ChatAction.currentPlayer.userName);
         }
      ...
      private function onHandler(param1:MouseEvent) : void
      {
         ...
         {
            case "btn_invite":
               if(_loc2_.Type < GalaxyType.GT_4)
               {
                  return;
               }
               this.Close(true);
            ...
            case "btn_enter":
               ...
               if(GalaxyType.GT_3 == _loc2_.Type && (_loc2_.FightFlag != 1 && _loc2_.Camp != 1))
               {
               ...
               if(GalaxyType.GT_2 == _loc2_.Type && (_loc2_.FightFlag != 1 && _loc2_.Camp != 1))
               {
               ...
               if(_loc2_.Type == GalaxyType.GT_3 || _loc2_.Type == GalaxyType.GT_2)
               {
