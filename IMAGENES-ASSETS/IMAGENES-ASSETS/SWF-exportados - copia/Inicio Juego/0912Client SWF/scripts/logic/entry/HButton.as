package logic.entry
{
   ...
   public class HButton
   {
      ...
      public function HButton(param1:MovieClip, param2:int = 2, param3:Boolean = false, param4:String = "", param5:Boolean = false)
      {
         super();
      ...
      private function onMouseOver(param1:MouseEvent) : void
      {
         ...
         if(this.m_tipText != "")
         {
            ...
            else
            {
               ...
               CustomTip.GetInstance().Show(this.m_tipText,_loc2_);
            }
         }
         if(this.m_statue == HButtonStatue.DISABLED)
         {
