package net.msg.ship
{
   ...
   public class MSG_RESP_JUMPGALAXYSHIP extends MsgHead
   {
      ...
      public function MSG_RESP_JUMPGALAXYSHIP()
      {
         var _loc2_:MSG_RESP_JUMPGALAXYSHIP_TEMP = null;
         this.Data = new Array(18);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 18)
         {
            _loc2_ = new MSG_RESP_JUMPGALAXYSHIP_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_JUMPGALAXYSHIP;
      }
