package net.msg.commanderMsg
{
   ...
   public class MSG_REQUEST_CLEARCOMMANDERPERCENT extends MsgHead
   {
      ...
      public function MSG_REQUEST_CLEARCOMMANDERPERCENT()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_CLEARCOMMANDERPERCENT;
      }
