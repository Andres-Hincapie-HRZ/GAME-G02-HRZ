package net.msg.commanderMsg
{
   ...
   public class MSG_REQUEST_COMMANDEREDITSHIPTEAM extends MsgHead
   {
      ...
      public function MSG_REQUEST_COMMANDEREDITSHIPTEAM()
      {
         ...
         usType = MsgTypes._MSG_REQUEST_COMMANDEREDITSHIPTEAM;
      }
