package net.msg.sciencesystem
{
   ...
   public class MSG_REQUEST_DELETEPROPS extends MsgHead
   {
      ...
      public function MSG_REQUEST_DELETEPROPS()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_DELETEPROPS;
      }
      ...
      public function writeBuf(param1:ByteArray) : void
      {
         ...
         _loc2_.writeChar(param1,this.LockFlag);
