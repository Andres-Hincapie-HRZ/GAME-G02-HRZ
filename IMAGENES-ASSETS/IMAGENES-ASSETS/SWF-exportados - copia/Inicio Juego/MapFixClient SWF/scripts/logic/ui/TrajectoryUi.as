package logic.ui
{
   ...
   public class TrajectoryUi extends AbstractPopUp
   {
      
      private static var instance:TrajectoryUi;
      ...
      public function TrajectoryUi()
      {
         super();
         setPopUpName("TrajectoryUi");
      }
      
      public static function getInstance() : TrajectoryUi
      {
         if(instance == null)
         {
            instance = new TrajectoryUi();
         }
         return instance;
      }
      ...
      override public function Init() : void
      {
         ...
         this._mc = new MObject("TrajectoryMc",0,0);
      ...
      override public function initMcElement() : void
      {
         ...
         {
            if(ScienceSystem.getinstance().levearr[_loc4_][0] < 16 && ScienceSystem.getinstance().levearr[_loc4_][0] >= 0)
            {
         ...
         while(_loc6_ < 16)
         {
            TextField(this.mc["mc_base" + _loc6_].tf_page).mouseEnabled = false;
      ...
      {
         this.mc["x0_1"].gotoAndStop(1);
         this.mc["x1_2"].gotoAndStop(1);
         this.mc["x1_3"].gotoAndStop(1);
         this.mc["x2_5"].gotoAndStop(1);
         this.mc["x4_5"].gotoAndStop(1);
         this.mc["x2_4_5"].gotoAndStop(1);
         this.mc["x3_4"].gotoAndStop(1);
         this.mc["x4_10"].gotoAndStop(1);
         this.mc["x10_11"].gotoAndStop(1);
         this.mc["x11_12"].gotoAndStop(1);
         this.mc["x5_6_7"].gotoAndStop(1);
         this.mc["x5_6"].gotoAndStop(1);
         this.mc["x5_7"].gotoAndStop(1);
         this.mc["x6_8"].gotoAndStop(1);
         this.mc["x7_8"].gotoAndStop(1);
         this.mc["x6_7_8"].gotoAndStop(1);
         this.mc["x8_9"].gotoAndStop(1);
         this.mc["x12_13"].gotoAndStop(1);
         this.mc["x13_14"].gotoAndStop(1);
         this.mc["x9_15"].gotoAndStop(1);
         this.mc["x14_15"].gotoAndStop(1);
         this.mc["x9_14_15"].gotoAndStop(1);
         var _loc1_:uint = 1;
         while(_loc1_ < 16)
         {
      ...
      public function closeHd(param1:uint, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(!param2)
         {
            RegisteredData.getInstance().hs(0,16,this.mc);
            if(param3 == 1)
            {
               return;
            }
      ...
      public function timeHd(param1:uint, param2:uint) : void
      {
         ...
         RegisteredData.getInstance().zsqs(0,16,param1);
      }
      
      private function raiingHd() : void
      {
         this.pdbo = false;
         this.mc["mc_base" + this._id].mc_base.sjj = 1;
         if(this.tm.running)
         {
            this.tm.stop();
         }
      ...
      private function raiHd(param1:MouseEvent) : void
      {
         ...
         {
            if(ScienceSystem.getinstance().zzsjarr[0].tc < 16)
            {
               return;
            }
         }
      ...
      private function ovHd(param1:MouseEvent) : void
      {
         ...
         if(this.levelarr[_loc2_] < CScienceReader.getInstance().weaponarr[_loc2_].length)
         {
            ...
            {
               if(ScienceSystem.getinstance().zzsjarr[0].CreditFlag == 0 && ScienceSystem.getinstance().zzsjarr[0].tc >= 16)
               {
                  if(GamePlayer.getInstance().cash < GamePlayer.getInstance().TechQueueCredit)
                  {
         ...
         if(_loc8_ == 5 || _loc8_ == 6 || _loc8_ == 7 || _loc8_ == 8 || _loc8_ == 9)
         {
            this.aa(2);
            if(_loc8_ > 5 && _loc8_ != 7)
            {
               this.aa(6);
            }
         }
      ...
      private function LineHd() : void
      {
         ...
         while(_loc1_ < this.xxarr.length)
         {
            ...
            if(_loc2_ == 5 || _loc3_ == 5)
            {
               this.mc["x" + 2 + "_" + 4 + "_" + 5].gotoAndStop(2);
            }
            if(_loc3_ == 6 || _loc3_ == 7)
            {
               this.mc["x" + 5 + "_" + 6 + "_" + 7].gotoAndStop(2);
            }
            if(_loc2_ == 8 || _loc3_ == 8)
            {
               this.mc["x" + 6 + "_" + 7 + "_" + 8].gotoAndStop(2);
            }
            if(_loc2_ == 15 || _loc3_ == 15)
            {
               this.mc["x" + 9 + "_" + 14 + "_" + 15].gotoAndStop(2);
            }
            _loc1_++;
         }
      }
