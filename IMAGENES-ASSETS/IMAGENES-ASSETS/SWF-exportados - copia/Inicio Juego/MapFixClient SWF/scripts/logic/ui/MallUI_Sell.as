package logic.ui
{
   ...
   public class MallUI_Sell
   {
      ...
      public function RespShipList(param1:MSG_RESP_ARRANGESHIPTEAM) : void
      {
         ...
         {
            this.MsgShipList.DataLen += param1.DataLen;
            this.MsgShipList.TeamBody = this.MsgShipList.TeamBody.concat(param1.TeamBody);
         }
      ...
      private function tf_onepriceChange(param1:Event) : void
      {
         ...
         if(this.tf_oneprice.text != "" && _loc2_ > 0)
         {
            ...
            if(_loc3_ > 600000000)
            {
               this.tf_oneprice.text = "600000000";
               _loc3_ = 600000000;
            }
