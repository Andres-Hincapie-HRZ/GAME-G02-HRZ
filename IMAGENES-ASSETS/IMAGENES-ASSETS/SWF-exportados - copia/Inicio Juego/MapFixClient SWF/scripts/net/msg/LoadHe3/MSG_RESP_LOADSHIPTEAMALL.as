package net.msg.LoadHe3
{
   ...
   public class MSG_RESP_LOADSHIPTEAMALL extends MsgHead
   {
      ...
      public function MSG_RESP_LOADSHIPTEAMALL()
      {
         var _loc2_:MSG_RESP_LOADSHIPTEAMALL_TEMP = null;
         this.Data = new Array(19);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 19)
         {
            _loc2_ = new MSG_RESP_LOADSHIPTEAMALL_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_LOADSHIPTEAMALL;
      }
