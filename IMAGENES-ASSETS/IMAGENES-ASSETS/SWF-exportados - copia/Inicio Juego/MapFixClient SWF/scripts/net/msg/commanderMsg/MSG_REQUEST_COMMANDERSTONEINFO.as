package net.msg.commanderMsg
{
   ...
   public class MSG_REQUEST_COMMANDERSTONEINFO extends MsgHead
   {
      ...
      public function MSG_REQUEST_COMMANDERSTONEINFO()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_COMMANDERSTONEINFO;
      }
