package net.msg.galaxyMap
{
   ...
   public class MSG_RESP_MAPAREA_TMP
   {
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.UserId = Number(Number(Number(_loc2_.readInt64(param1))));
         this.GalaxyId = int(int(int(_loc2_.readInt(param1))));
         this.Reserve1 = int(int(int(_loc2_.readInt(param1))));
         this.StarFace = int(int(int(_loc2_.readChar(param1))));
         this.InsertFlagStatus = int(int(int(_loc2_.readChar(param1))));
         this.ConsortiaHeadId = int(int(int(_loc2_.readUnsignChar(param1))));
         this.ConsortiaLevelId = int(int(int(_loc2_.readUnsignChar(param1))));
         this.Type = int(int(int(_loc2_.readChar(param1))));
         if(this.Type == 2)
         {
         }
         this.FightFlag = int(int(int(_loc2_.readChar(param1))));
         this.Camp = int(int(int(_loc2_.readChar(param1))));
         this.SpaceLevelId = int(int(int(_loc2_.readChar(param1))));
         _loc2_ = null;
         ExternalInterface.call("console.log","[#] MAPAREA_TMP (PL) => " + this.UserName + ", " + this.Reserve1 + ", " + this.GalaxyId + ", " + this.Camp);
      }
