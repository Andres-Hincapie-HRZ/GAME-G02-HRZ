package net.msg.commanderMsg
{
   ...
   public class MSG_REQUEST_UPDATENAMECOMMANDER extends MsgHead
   {
      ...
      public function MSG_REQUEST_UPDATENAMECOMMANDER()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_UPDATENAMECOMMANDER;
      }
