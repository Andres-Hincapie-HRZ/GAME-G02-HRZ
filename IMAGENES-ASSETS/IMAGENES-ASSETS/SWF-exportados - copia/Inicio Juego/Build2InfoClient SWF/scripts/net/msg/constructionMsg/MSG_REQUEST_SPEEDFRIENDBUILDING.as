package net.msg.constructionMsg
{
   ...
   public class MSG_REQUEST_SPEEDFRIENDBUILDING extends MsgHead
   {
      ...
      public function MSG_REQUEST_SPEEDFRIENDBUILDING()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_SPEEDFRIENDBUILDING;
      }
