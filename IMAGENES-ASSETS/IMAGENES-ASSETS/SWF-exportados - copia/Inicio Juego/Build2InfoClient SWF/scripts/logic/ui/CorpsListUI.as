package logic.ui
{
   ...
   import net.msg.corpsMsg.MSG_REQUEST_CONSORTIAINFO2;
   ...
   public class CorpsListUI extends AbstractPopUp
   {
      ...
      {
         if(this.tf_search.text == "")
         {
            return;
         }
         var _loc2_:MSG_REQUEST_CONSORTIAINFO2 = new MSG_REQUEST_CONSORTIAINFO2();
         _loc2_.SeqId = GamePlayer.getInstance().seqID++;
         _loc2_.Guid = GamePlayer.getInstance().Guid;
         _loc2_.Name = this.tf_search.text;
