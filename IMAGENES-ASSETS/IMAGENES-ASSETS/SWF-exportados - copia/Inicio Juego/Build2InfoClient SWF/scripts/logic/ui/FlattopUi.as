package logic.ui
{
   ...
   public class FlattopUi extends AbstractPopUp
   {
      
      private static var instance:FlattopUi;
      ...
      public function FlattopUi()
      {
         super();
         setPopUpName("FlattopUi");
      }
      
      public static function getInstance() : FlattopUi
      {
         if(instance == null)
         {
            instance = new FlattopUi();
         }
         return instance;
      }
      ...
      override public function Init() : void
      {
         ...
         this._mc = new MObject("FlattopMc",0,0);
      ...
      override public function initMcElement() : void
      {
         ...
         {
            if(ScienceSystem.getinstance().levearr[_loc4_][0] >= 48 && ScienceSystem.getinstance().levearr[_loc4_][0] < 64)
            {
      ...
      {
         this.mc["x48_49_54_57"].gotoAndStop(1);
         this.mc["x48_49"].gotoAndStop(1);
         this.mc["x48_54"].gotoAndStop(1);
         this.mc["x48_57"].gotoAndStop(1);
         this.mc["x49_50"].gotoAndStop(1);
         this.mc["x50_51"].gotoAndStop(1);
         this.mc["x51_52"].gotoAndStop(1);
         this.mc["x52_53"].gotoAndStop(1);
         this.mc["x53_62"].gotoAndStop(1);
         this.mc["x50_55"].gotoAndStop(1);
         this.mc["x54_55"].gotoAndStop(1);
         this.mc["x55_56"].gotoAndStop(1);
         this.mc["x56_62"].gotoAndStop(1);
         this.mc["x58_55"].gotoAndStop(1);
         this.mc["x61_56"].gotoAndStop(1);
         this.mc["x57_58"].gotoAndStop(1);
         this.mc["x58_59"].gotoAndStop(1);
         this.mc["x59_60"].gotoAndStop(1);
         this.mc["x60_61"].gotoAndStop(1);
         this.mc["x62_63"].gotoAndStop(1);
         var _loc1_:uint = 49;
         while(_loc1_ < 64)
         {
      ...
      public function closeHd(param1:uint, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(!param2)
         {
            RegisteredData.getInstance().hs(48,64,this.mc);
            if(param3 == 1)
            {
               return;
            }
      ...
      public function timeHd(param1:uint, param2:uint) : void
      {
         ...
         RegisteredData.getInstance().zsqs(48,64,param1);
      }
      ...
      private function raiHd(param1:MouseEvent) : void
      {
         ...
         {
            if(ScienceSystem.getinstance().zzsjarr[0].tc >= 48 && ScienceSystem.getinstance().zzsjarr[0].tc < 64)
            {
               return;
            }
         }
      ...
      private function ovHd(param1:MouseEvent) : void
      {
         ...
         if(this.levelarr[_loc2_] < CScienceReader.getInstance().weaponarr[_loc2_].length)
         {
            ...
            {
               if(ScienceSystem.getinstance().zzsjarr[0].CreditFlag == 0 && ScienceSystem.getinstance().zzsjarr[0].tc >= 64 || ScienceSystem.getinstance().zzsjarr[0].tc < 48)
               {
                  if(GamePlayer.getInstance().cash < GamePlayer.getInstance().TechQueueCredit)
                  {
         ...
         if(_loc8_ == 55 || _loc8_ == 56 || _loc8_ == 62 || _loc8_ == 63)
         {
            this.aa(58);
            this.aa(54);
            this.aa(50);
            if(_loc8_ == 56 || _loc8_ == 62 || _loc8_ == 63)
            {
               this.aa(55);
               if(_loc8_ == 62 || _loc8_ == 63)
               {
                  this.aa(56);
                  this.aa(51);
                  this.aa(52);
      ...
      private function LineHd() : void
      {
         ...
         while(_loc1_ < this.xxarr.length)
         {
            ...
            if(_loc2_ == 48 || _loc3_ == 48)
            {
               this.mc["x48_49_54_57"].gotoAndStop(2);
            }
            _loc1_++;
         }
      }
