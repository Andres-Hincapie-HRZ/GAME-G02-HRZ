package logic.ui
{
   ...
   import net.msg.FlagShip.MSG_REQUEST_UPGRADESHIPPROPS;
   ...
   public class UpgradeUI extends AbstractPopUp
   {
      ...
      override public function initMcElement() : void
      {
         ...
         var _loc4_:* = this._mc.getMC().getChildByName("btn_upgrade");
         if(_loc4_)
         {
            _loc2_ = _loc4_ as MovieClip;
            _loc2_.addEventListener(MouseEvent.CLICK,this.btn_upgradeClick);
            this.btn_upgrade = new HButton(_loc2_,HButtonType.SIMPLE,false,StringManager.getInstance().getMessageString("Boss191"));
         ...
         while(_loc6_ < 5)
         {
            _loc9_ = this.UpgradeItemList.getChildByName("mc_list" + _loc6_) as MovieClip;
            _loc5_ = new XMovieClip(_loc9_);
            _loc5_.Data = _loc6_;
            ...
            _loc9_.addEventListener(MouseEvent.MOUSE_OUT,this.McItemMouseOut);
            _loc9_ = this.UpgradeItemList.getChildByName("mc_plan" + _loc6_) as MovieClip;
            _loc5_ = new XMovieClip(_loc9_);
            _loc5_.Data = _loc6_;
            _loc5_.OnClick = this.ItemClick;
            _loc9_.stop();
            ...
            _loc5_.OnMouseOver = this.McItemMouseOver;
            _loc9_.addEventListener(MouseEvent.MOUSE_OUT,this.McItemMouseOut);
            _loc9_ = this.UpgradeItemList.getChildByName("btn_cancel" + _loc6_) as MovieClip;
            _loc9_.stop();
            _loc9_.visible = false;
            _loc6_++;
         }
         this.BodyInfoList = this._mc.getMC().mc_shipchange as MovieClip;
         _loc7_ = this.BodyInfoList.mc_hudun0.tf_planbar as TextField;
         this.DiffFormat = _loc7_.getTextFormat();
         this.DiffFormat.color = 12747274;
         this.NormalFormat = _loc7_.getTextFormat();
         this.ClearBodyInfo();
         this.PartInfoList = this._mc.getMC().mc_modulechange as MovieClip;
         this.ClearPartInfo();
         _loc8_ = this.PartInfoList.mc_gongjili0 as DisplayObject;
         this.LastY1 = _loc8_.y;
         _loc8_ = this.PartInfoList.mc_shecheng0 as DisplayObject;
         this.LastY2 = _loc8_.y;
         _loc8_ = this.PartInfoList.mc_huihe0 as DisplayObject;
         this.LastY3 = _loc8_.y;
         _loc8_ = this.PartInfoList.mc_tiji0 as DisplayObject;
         this.LastY4 = _loc8_.y;
      ...
      private function btn_upgradeClick(param1:MouseEvent) : void
      {
         if(this.mc_module)
         {
            this.mc_module.visible = true;
         }
         this.ResetSelectedTypeBtn(this.btn_upgrade);
         if(this.SelectedItem != null)
         {
            this.SelectedItem.gotoAndStop("up");
         }
      ...
      private function InitChip(param1:int = 36) : void
      {
         ...
         {
            _loc5_ = CPropsReader.getInstance().GetPropsInfo(_loc2_[_loc3_].PropsId);
            if(_loc5_.List == param1)
            {
               this.FlagChipInfo = new PackPropsInfo();
               this.FlagChipInfo._PropsInfo = _loc5_;
               this.FlagChipInfo.Num = _loc2_[_loc3_].PropsNum;
               this.FlagChipInfo.LockFlag = _loc2_[_loc3_].LockFlag;
               break;
            }
            _loc3_++;
         }
         ...
         var _loc4_:Sprite = Sprite(this._mc.getMC().mc_module.mc_base);
         if(_loc4_.numChildren > 0)
         {
            _loc4_.removeChildAt(0);
         }
         if(param1 == 36)
         {
            _loc4_.addChildAt(new Bitmap(GameKernel.getTextureInstance("Props3006")),0);
         }
         else if(param1 == 51)
         {
            _loc4_.addChildAt(new Bitmap(GameKernel.getTextureInstance("Props4440")),0);
         }
      ...
      private function UpgradeClick(param1:Event) : void
      {
         ...
         var _loc4_:MSG_REQUEST_UPGRADESHIPPROPS = null;
         ...
         else
         {
            ...
            if(_loc2_.UpgradeTime > this.FlagChipInfo.Num)
            {
               ...
               {
                  MessagePopup.getInstance().Show(StringManager.getInstance().getMessageString("Boss192"),0);
               }
               return;
            }
            ...
            {
               _loc4_ = new MSG_REQUEST_UPGRADESHIPPROPS();
               _loc4_.ShipBodyId = _loc2_.Id;
      ...
      public function Resp_MSG_RESP_UPGRADESHIPPROPS(param1:MSG_RESP_UPGRADESHIPPROPS) : void
      {
         var _loc5_:int = 0;
         this.Invalid(true);
