package net.msg.sciencesystem
{
   ...
   public class MSG_RESP_TECHINFO extends MsgHead
   {
      ...
      public function MSG_RESP_TECHINFO()
      {
         var _loc2_:MSG_RESP_TECHINFO_TEMP = null;
         this.Data = new Array(250);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 250)
         {
            _loc2_ = new MSG_RESP_TECHINFO_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_TECHINFO;
      }
