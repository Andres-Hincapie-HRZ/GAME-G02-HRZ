package net.msg.Compose
{
   ...
   public class MSG_REQUEST_COMMANDERINSERTCMOS extends MsgHead
   {
      ...
      public function MSG_REQUEST_COMMANDERINSERTCMOS()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_COMMANDERINSERTCMOS;
      }
      ...
      public function writeBuf(param1:ByteArray) : void
      {
         ...
         _loc2_.writeInt(param1,this.CmosId);
