package net.msg.field
{
   ...
   public class MSG_RESP_FIELDRESOURCELOG extends MsgHead
   {
      ...
      public function MSG_RESP_FIELDRESOURCELOG()
      {
         var _loc2_:MSG_RESP_FIELDRESOURCELOG_TEMP = null;
         this.Data = new Array(15);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 15)
         {
            _loc2_ = new MSG_RESP_FIELDRESOURCELOG_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_FIELDRESOURCELOG;
      }
