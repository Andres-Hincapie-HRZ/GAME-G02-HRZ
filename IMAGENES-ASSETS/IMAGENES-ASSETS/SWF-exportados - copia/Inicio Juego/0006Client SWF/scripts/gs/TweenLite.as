package gs
{
   ...
   public class TweenLite
   {
      ...
      public function TweenLite(param1:Object, param2:Number, param3:Object)
      {
         ...
         this.target = param1;
         this._isDisplayObject = Boolean(param1 is DisplayObject || param1.hasOwnProperty("isTweenProxy"));
      ...
      public function initTweenVals(param1:Boolean = false, param2:String = "") : void
      {
         ...
         {
            if((typeof this._specialVars.tint != "undefined" || this.vars.removeTint == true) && Boolean(this.target.hasOwnProperty("transform")))
            {
            ...
            {
               if(!(_loc3_ == "ease" || _loc3_ == "delay" || _loc3_ == "overwrite" || _loc3_ == "onComplete" || _loc3_ == "onCompleteParams" || _loc3_ == "runBackwards" || _loc3_ == "visible" || _loc3_ == "autoOverwrite" || _loc3_ == "persist" || _loc3_ == "onUpdate" || _loc3_ == "onUpdateParams" || _loc3_ == "autoAlpha" || _loc3_ == "onStart" || _loc3_ == "onStartParams" || _loc3_ == "renderOnStart" || _loc3_ == "proxiedEase" || _loc3_ == "easeParams" || param1 && param2.indexOf(" " + _loc3_ + " ") != -1))
               {
