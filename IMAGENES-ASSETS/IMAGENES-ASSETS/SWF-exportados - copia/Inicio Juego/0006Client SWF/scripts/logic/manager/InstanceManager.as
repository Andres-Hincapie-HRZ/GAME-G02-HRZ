package logic.manager
{
   ...
   public class InstanceManager
   {
      ...
      public function requestStartFB(param1:Array) : void
      {
         ...
         _loc3_ = _loc3_ > MsgTypes.MAX_USERSHIPTEAMNUM ? int(MsgTypes.MAX_USERSHIPTEAMNUM) : int(_loc3_);
         var _loc6_:int = 0;
         while(_loc6_ < _loc3_)
         {
      ...
      public function checkShipGas() : Boolean
      {
         ...
         _loc1_ = _loc1_ > MsgTypes.MAX_USERSHIPTEAMNUM ? int(MsgTypes.MAX_USERSHIPTEAMNUM) : int(_loc1_);
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_)
         {
      ...
      public function respone_MSG_RESP_ECTYPESTATE(param1:int, param2:int, param3:ByteArray) : void
      {
         ...
         switch(this._curStatus)
         {
            case 0:
               ...
               ExternalInterface.call("console.log","[#] CASE 0 => ");
               break;
            case 1:
               ...
               FightManager.instance.CleanFight();
               ExternalInterface.call("console.log","[#] CASE 1 => ");
               break;
            case 2:
               if(WrestleUI.getInstance().WatchStatus == 1)
               {
      ...
      public function drawPassLine() : void
      {
         ...
         while(_loc4_ < this._passedFB.length)
         {
            ...
            _loc3_.pass = true;
            _loc2_ = _loc1_ > _loc2_ ? int(_loc1_) : int(_loc2_);
      ...
      public function quitInstance() : void
      {
         ...
         RaidProps.getInstance().LeaveView();
         BattlefieldUI.getInstance().LeaveView();
         GymkhanaUI.getInstance().leave();
      }
