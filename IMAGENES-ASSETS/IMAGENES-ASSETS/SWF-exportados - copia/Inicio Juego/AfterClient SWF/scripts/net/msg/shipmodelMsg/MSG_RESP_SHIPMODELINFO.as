package net.msg.shipmodelMsg
{
   ...
   public class MSG_RESP_SHIPMODELINFO extends MsgHead
   {
      ...
      public function MSG_RESP_SHIPMODELINFO()
      {
         ...
         usType = uint(uint(MsgTypes._MSG_RESP_SHIPMODELINFO));
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.DataLen = uint(uint(_loc2_.readUnsignShort(param1)));
         var _loc3_:int = 0;
         ExternalInterface.call("console.log","[#] {} " + usSize);
         ExternalInterface.call("console.log","DataLen = " + this.DataLen);
         while(_loc3_ < this.DataLen)
         {
            ExternalInterface.call("console.log","[#] START FROW " + _loc3_);
            if(param1.length > param1.position)
            {
               this.Data[_loc3_].readBuf(param1);
            }
            ExternalInterface.call("console.log","[#] END FROW " + _loc3_);
            _loc3_++;
         }
