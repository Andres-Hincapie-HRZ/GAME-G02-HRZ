package net.msg.shipmodelMsg
{
   ...
   public class MSG_RESP_SHIPMODELINFO_TEMP
   {
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.PartNum = int(int(_loc2_.readChar(param1)));
         this.PubFlag = int(int(_loc2_.readChar(param1)));
         this.BodyId = int(int(_loc2_.readShort(param1)));
         var _loc3_:int = 0;
         ...
         this.ShipModelId = int(int(_loc2_.readInt(param1)));
         _loc2_ = null;
      }
