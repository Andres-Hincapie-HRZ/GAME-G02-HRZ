package com.star.frameworks.utils
{
   ...
   public class HashSet
   {
      ...
      public function Keys() : Array
      {
         ...
         var _loc2_:Array = new Array(this.length);
         var _loc3_:int = 0;
         for(_loc2_[_loc3_] in this.content)
         {
            _loc3_++;
         }
         return _loc2_;
      ...
      public function Clone() : HashSet
      {
         ...
         for(_loc1_ in this.content)
         {
            _loc2_.Put(_loc1_,this.content[_loc1_]);
         }
         return _loc2_;
      }
