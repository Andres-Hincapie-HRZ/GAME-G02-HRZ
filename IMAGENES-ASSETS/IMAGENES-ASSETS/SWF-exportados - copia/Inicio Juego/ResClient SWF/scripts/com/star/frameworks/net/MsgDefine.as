package com.star.frameworks.net
{
   ...
   public class MsgDefine
   {
      ...
      public function GetIntFromBuffer(param1:int, param2:int, param3:int, param4:int) : int
      {
         ...
         ExternalInterface.call("console.log","[#] param1 : " + param1 + ", param2 : " + param2 + ", param3 : " + param3 + ", param4 : " + param4);
         var res:int = param4 * 256 * 256 * 256 + param3 * 256 * 256 + param2 * 256 + param1;
         ExternalInterface.call("console.log","[#] CCALC => " + res);
         return res;
      }
