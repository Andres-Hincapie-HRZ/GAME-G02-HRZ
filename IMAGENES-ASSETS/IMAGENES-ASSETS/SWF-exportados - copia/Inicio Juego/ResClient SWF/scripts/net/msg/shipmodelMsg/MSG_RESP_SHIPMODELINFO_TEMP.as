package net.msg.shipmodelMsg
{
   ...
   public class MSG_RESP_SHIPMODELINFO_TEMP
   {
      ...
      {
         ExternalInterface.call("console.log","[#] EFE ");
         var _loc2_:MsgSocket = MsgSocket.Instance();
         _loc2_.GetByte(param1,(4 - param1.position) % 4 % 4);
         this.ShipName = _loc2_.readUtf8Str(param1,MsgTypes.MAX_NAME);
         this.PartNum = int(int(int(_loc2_.readChar(param1))));
         this.PubFlag = int(int(int(_loc2_.readChar(param1))));
         this.BodyId = int(int(int(_loc2_.readShort(param1))));
         ExternalInterface.call("console.log","[#] ShipName " + this.ShipName);
         ExternalInterface.call("console.log","[#] BodyId " + this.BodyId);
         var _loc3_:int = 0;
         while(_loc3_ < MsgTypes.MAX_SHIPPART)
         {
            ExternalInterface.call("console.log","[#] OverFlow => " + param1.position + ", " + param1.length);
         ...
         ExternalInterface.call("console.log","[#] Nana ");
         this.ShipModelId = int(int(int(_loc2_.readInt(param1))));
         ExternalInterface.call("console.log","[#] Lucy ");
         _loc2_ = null;
      }
