package net.msg.gymkhanaMSg
{
   ...
   public class MSG_RESP_SETRACINGSHIPTEAM extends MsgHead
   {
      
      public var ShipTeamLen:int;
      
      public var ShipTeamId:Array = new Array(MsgTypes.MAX_RACINGSHIPTEAMNUM);
      
      public function MSG_RESP_SETRACINGSHIPTEAM()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_SETRACINGSHIPTEAM;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.ShipTeamLen = _loc2_.readInt(param1);
         var _loc3_:int = 0;
      ...
      public function writeBuf(param1:ByteArray) : void
      {
         ...
         _loc2_.writeInt(param1,this.ShipTeamLen);
         var _loc3_:int = 0;
         while(_loc3_ < MsgTypes.MAX_RACINGSHIPTEAMNUM)
         {
