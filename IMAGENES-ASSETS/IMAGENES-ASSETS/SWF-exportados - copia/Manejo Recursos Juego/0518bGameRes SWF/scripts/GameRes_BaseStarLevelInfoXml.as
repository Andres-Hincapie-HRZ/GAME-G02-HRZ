   ...
   public class GameRes_BaseStarLevelInfoXml
   {
	...
	<CapacityInfo Type="PopWnd"  Spacing="2" Rectangle="20,15,295,236" ResKey="GameRes" Visible="1" Enabled="0" Dragable="0" BackgroundColor="0x000000" BackgroundAlpha="1">
     ...
     <CapacityInfo Type="PopWnd" LayoutType="0" Spacing="2" Rectangle="20,15,295,236" ResKey="GameRes" Visible="1" Enabled="0" Dragable="0" BackgroundColor="0x000000" BackgroundAlpha="1">
		<BuildingName Type="Text" Rectangle="10,10,80,20" SText="S_X1_10" Font="Tahoma" WrapWord="0" FontSize="12" FontColor="0xccba7a" Border="0" IsShow="1" Selectabled="0" TextDefault="Resource Storage:"/>
		...
		<CommentDesc Type="Text" Rectangle="10,260,150,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFF0000" WrapWord="0" Border="1" IsShow="1" Selectabled="0" TextDefault="(Can only be upgraded by a Colonel)"/>
     </CapacityInfo>
</data>;
