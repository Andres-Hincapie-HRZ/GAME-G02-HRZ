package
{
   public class GameRes_ScienceInfoXml
   {
	...
	<ScienceInfo Type="PopWnd" Rectangle="20,15,295,236" ResKey="GameRes" Visible="1" Enabled="0" Dragable="0" BackgroundColor="0x000000" BackgroundAlpha="1">
		<BuildingName Type="Text" Rectangle="30,0,80,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0" TextDefault="Metal Collecting Center:"/>
		<BuildingLvTxt Type="Text" Rectangle="0,20,40,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0" TextDefault="Lv2"/>
		
		<CommentDesc Type="Text" Rectangle="0,40,250,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0" TextDefault="A place to extract and refine metal. Upgrade to increase the production of metal."/>
		...
		<Context Type="Text" Rectangle="0,170,80,120" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0 " TextDefault="Description"/>
