package
{
   public class GameRes_InfoXml
   {
	...
	<ResCapacityInfo Type="PopWnd" LayoutType="0" Spacing="4" Rectangle="20,15,295,236" ResKey="GameRes" Visible="1" Enabled="0" Dragable="0" BackgroundColor="0x000000" BackgroundAlpha="1">
		<BuildingName Type="Text" Rectangle="100,5,80,20" SText="S_X1_10" Font="Tahoma" FontSize="12" WrapWord="0" FontColor="0xccba7a" Border="0" IsShow="1" Selectabled="0" TextDefault="Extractor de Metal:"/>
		<BuildingLvTxt Type="Text" Rectangle="220,5,260,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0x00ff00" Border="0" IsShow="1" Selectabled="0" TextDefault="Nv. 2"/>
		<CommentDesc Type="Text" Rectangle="10,25,260,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0" TextDefault="Un lugar para extraer y refinar metal. Mejóralo para aumentar la producción de metal."/>
		...
		<UpgradeTime Type="Text" Rectangle="10,160,80,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xccba7a" Border="0" IsShow="1" Selectabled="0 " TextDefault="Costo (tiempo)"/>
		...
		<UpgradeDepend Type="Text" Rectangle="10,180,80,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xccba7a" Border="0" IsShow="0" Selectabled="0 " TextDefault="Requisito de mejora"/>
		...
		<ConstructionNumTxt Type="Text" Rectangle="90,200,100,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xff0000" WrapWord="0" Border="0" IsShow="0" Selectabled="0 " TextDefault="(Se ha alcanzado el límite máximo."/>
   </ResCapacityInfo>
</data>;
