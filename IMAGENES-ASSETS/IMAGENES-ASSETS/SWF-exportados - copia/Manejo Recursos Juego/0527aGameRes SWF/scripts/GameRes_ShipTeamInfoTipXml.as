package
{
   public class GameRes_ShipTeamInfoTipXml
   {
	...
	<ShipTeamInfoTip Type="PopWnd" LayoutType="-1" Rectangle="20,15,325,266" ResKey="GameRes" Visible="1" Enabled="0" Dragable="0" BackgroundColor="0x000000" BackgroundAlpha="1">
		...
		<CommanderNameTxt Type="Text" Rectangle="60,30,150,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0" TextDefault="Comandante:"/>
		...
		<CommandLevelTxt Type="Text" Rectangle="60,50,150,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0 " TextDefault="Nv.:"/>
		...
		<UserNameTxt Type="Text" Rectangle="10,80,150,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0 " TextDefault="De:"/>
		...
		<CropsTxt Type="Text" Rectangle="10,100,150,20" SText="S_X1_10" Font="Tahoma" FontSize="12" FontColor="0xFFFFFF" Border="0" IsShow="1" Selectabled="0 " TextDefault="Alianza:"/>
