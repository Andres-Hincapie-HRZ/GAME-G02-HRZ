package logic.entry
{
   ...
   public class GamePlayer
   {
      ...
      public var UserCrystal:uint;
      
      public var UserHe3:uint;
      ...
      public function init(param1:MSG_ROLE_INFO) : void
      {
         ...
         this.NoviceGuide = param1.NoviceGuide;
         this.WarScoreExchange = param1.WarScoreExchange;
         if(!this.galaxyStar)
         {
      ...
      {
         return this.language > 10 && this.language != 14 && this.language != 11 && this.language != 12;
      }
