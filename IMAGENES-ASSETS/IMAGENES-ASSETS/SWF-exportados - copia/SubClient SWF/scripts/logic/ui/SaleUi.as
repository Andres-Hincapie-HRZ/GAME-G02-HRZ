package logic.ui
{
   ...
   public class SaleUi extends AbstractPopUp
   {
      ...
      override public function initMcElement() : void
      {
         ...
         TextField(this.content.tf_oneprice).maxChars = 9;
      ...
      {
         var _loc2_:int = int(TextField(this.content.tf_oneprice).text);
         if(_loc2_ > 600000000)
         {
            TextField(this.content.tf_oneprice).text = "600000000";
         }
         this.ppsd();
      }
