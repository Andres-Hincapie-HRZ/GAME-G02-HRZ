package net.msg.galaxyMap
{
   ...
   public class MSG_RESP_MAPAREA extends MsgHead
   {
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         var _loc3_:int = 0;
         ExternalInterface.call("console.log","[#] [REGION] = " + this.RegionId);
         while(_loc3_ < 25)
         {
         ...
         _loc2_ = null;
         ExternalInterface.call("console.log","[#] [RG] " + this.RegionId);
         ExternalInterface.call("console.log","[#] [GMAPID] " + this.GalaxyMapId);
         ExternalInterface.call("console.log","[#] [BTRESP] " + this.DataLen);
      }
