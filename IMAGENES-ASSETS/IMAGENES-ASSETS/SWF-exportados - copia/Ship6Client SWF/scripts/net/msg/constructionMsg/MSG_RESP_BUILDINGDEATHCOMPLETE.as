package net.msg.constructionMsg
{
   ...
   public class MSG_RESP_BUILDINGDEATHCOMPLETE extends MsgHead
   {
      ...
      public function MSG_RESP_BUILDINGDEATHCOMPLETE()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_BUILDINGDEATHCOMPLETE;
      }
