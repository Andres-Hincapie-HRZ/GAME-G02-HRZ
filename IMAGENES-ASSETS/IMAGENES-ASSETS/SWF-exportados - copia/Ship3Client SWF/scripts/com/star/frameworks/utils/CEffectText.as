package com.star.frameworks.utils
{
   ...
   public class CEffectText
   {
      ...
      public function showEffectText(param1:DisplayObjectContainer, param2:String, param3:Boolean = false, param4:Boolean = true) : void
      {
      ...
      {
         if(Boolean(this.m_parent) && this.m_parent.getChildIndex(this.mBg) != -1)
         {
