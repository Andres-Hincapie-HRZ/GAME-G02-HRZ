package net.router
{
   ...
   public class MallRouter
   {
      ...
      public function resp_MSG_RESP_BUYGOODS(param1:int, param2:int, param3:ByteArray) : void
      {
         ...
         {
            GamePlayer.getInstance().WarScoreExchange = GamePlayer.getInstance().WarScoreExchange - _loc4_.Price;
         }
         ...
         {
            BattleMall.getInstance().ShowHonor();
         }
         else
         {
