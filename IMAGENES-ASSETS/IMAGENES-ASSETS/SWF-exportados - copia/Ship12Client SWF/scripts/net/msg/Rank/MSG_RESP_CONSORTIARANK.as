package net.msg.Rank
{
   ...
   public class MSG_RESP_CONSORTIARANK extends MsgHead
   {
      ...
      public function MSG_RESP_CONSORTIARANK()
      {
         var _loc2_:MSG_RESP_CONSORTIARANK_TEMP = null;
         this.Data = new Array(6);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 6)
         {
            _loc2_ = new MSG_RESP_CONSORTIARANK_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_CONSORTIARANK;
      }
      ...
      public function writeBuf(param1:ByteArray) : void
      {
         ...
         _loc2_.writeInt(param1,this.ConsortiaCount);
