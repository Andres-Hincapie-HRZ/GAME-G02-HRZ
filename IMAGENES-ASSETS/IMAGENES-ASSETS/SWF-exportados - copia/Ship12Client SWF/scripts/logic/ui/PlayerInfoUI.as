package logic.ui
{
   ...
   public class PlayerInfoUI
   {
      ...
      public function Init(param1:MObject) : void
      {
         ...
         if(this._mc.stage)
         {
            this.LastStageWidth = int(int(int(int(this._mc.stage.stageWidth))));
      ...
      public function bindPlayerImage() : void
      {
         ...
         _loc1_.LoadImage("http://51.222.141.200:8080/images/frymire.png",this.mc_base,this.playerCallBack,true);
      ...
      public function bindFriendImage(param1:Number) : void
      {
         ...
         if(GameKernel.ForRenRen == 1)
         {
            ...
            else
            {
               ...
               _loc4_.LoadImage("http://51.222.141.200:8080/images/frymire.png",this.mc_base,this.playerCallBack,GameKernel.ForRenRen == 1);
            }
            if(_loc2_)
            {
