package logic.ui
{
   ...
   public class AirshipUi extends AbstractPopUp
   {
      
      private static var instance:AirshipUi;
      ...
      public function AirshipUi()
      {
         super();
         setPopUpName("AirshipUi");
      }
      
      public static function getInstance() : AirshipUi
      {
         if(instance == null)
         {
            instance = new AirshipUi();
         }
         return instance;
      }
      ...
      override public function Init() : void
      {
         ...
         this._mc = new MObject("AirshipMc",0,0);
      ...
      override public function initMcElement() : void
      {
         ...
         {
            if(ScienceSystem.getinstance().levearr[_loc4_][0] >= 70 && ScienceSystem.getinstance().levearr[_loc4_][0] < 89)
            {
         ...
         while(_loc6_ < 89)
         {
            ...
            this.mc["mc_base" + _loc6_].tf_page.text = CScienceReader.getInstance().DefenceTechAry[_loc6_].title;
            if(this.levelarr[_loc6_] != 0)
            {
               this.mc["mc_base" + _loc6_].tf_page.text = String(CScienceReader.getInstance().defencearr[_loc6_][this.levelarr[_loc6_] - 1].Title);
            }
      ...
      {
         this.mc["x70_71_80"].gotoAndStop(1);
         this.mc["x70_71"].gotoAndStop(1);
         this.mc["x70_80"].gotoAndStop(1);
         this.mc["x71_72"].gotoAndStop(1);
         this.mc["x80_81"].gotoAndStop(1);
         this.mc["x72_73_76"].gotoAndStop(1);
         this.mc["x72_73"].gotoAndStop(1);
         this.mc["x72_76"].gotoAndStop(1);
         this.mc["x81_82_85"].gotoAndStop(1);
         this.mc["x81_82"].gotoAndStop(1);
         this.mc["x81_85"].gotoAndStop(1);
         this.mc["x73_74"].gotoAndStop(1);
         this.mc["x76_77"].gotoAndStop(1);
         this.mc["x82_83"].gotoAndStop(1);
         this.mc["x82_83"].gotoAndStop(1);
         this.mc["x85_86"].gotoAndStop(1);
         this.mc["x74_75"].gotoAndStop(1);
         this.mc["x77_78"].gotoAndStop(1);
         this.mc["x83_84"].gotoAndStop(1);
         this.mc["x86_87"].gotoAndStop(1);
         this.mc["x75_79"].gotoAndStop(1);
         this.mc["x75_78_79"].gotoAndStop(1);
         this.mc["x78_79"].gotoAndStop(1);
         this.mc["x84_88"].gotoAndStop(1);
         this.mc["x78_79"].gotoAndStop(1);
         this.mc["x84_88"].gotoAndStop(1);
         this.mc["x84_87_88"].gotoAndStop(1);
         this.mc["x87_88"].gotoAndStop(1);
         var _loc1_:uint = 71;
         while(_loc1_ < 89)
         {
      ...
      public function closeHd(param1:uint, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(!param2)
         {
            RegisteredData.getInstance().hs(70,89,this.mc);
            if(param3 == 1)
            {
               return;
            }
         ...
         this.mc["mc_base" + param1].tf_page.text = String(CScienceReader.getInstance().defencearr[param1][_loc4_ - 1].Title);
         RegisteredData.getInstance().hs(70,89,this.mc);
         this.xxarr.length = 0;
         this.barr.length = 0;
         this.carr.length = 0;
      ...
      public function timeHd(param1:uint, param2:uint) : void
      {
         ...
         this._totm = CScienceReader.getInstance().defencearr[this._id][_loc3_].Time;
         ...
         RegisteredData.getInstance().zsqs(70,89,param1);
      }
      ...
      private function raiHd(param1:MouseEvent) : void
      {
         ...
         if(this.levelarr[_loc2_] >= CScienceReader.getInstance().defencearr[_loc2_].length)
         {
            return;
         }
         ...
         {
            if(ScienceSystem.getinstance().zzsjarr[0].tc >= 70 && ScienceSystem.getinstance().zzsjarr[0].tc < 89)
            {
               return;
            }
         }
         ...
         if(CScienceReader.getInstance().defencearr[_loc2_][_loc3_].Money > GamePlayer.getInstance().UserMoney)
         {
            return;
         }
         this.buqian = CScienceReader.getInstance().defencearr[_loc2_][_loc3_].Money;
         RegisteredData.getInstance().money = CScienceReader.getInstance().defencearr[_loc2_][_loc3_].Money;
         var _loc4_:uint = 0;
         if(ScienceSystem.getinstance().zzsjarr.length == 0)
         {
            _loc4_ = 0;
         ...
         ConstructionAction.getInstance().costResource(0,0,CScienceReader.getInstance().defencearr[_loc2_][_loc3_].Money,0);
      ...
      private function ovHd(param1:MouseEvent) : void
      {
         ...
         this.tip.name_txt.text = String(CScienceReader.getInstance().DefenceTechAry[_loc2_].name);
         var _loc3_:int = int(this.levelarr[_loc2_]);
         if(_loc3_ <= 0)
         {
            _loc3_ = 0;
         ...
         if(this.levelarr[_loc2_] < CScienceReader.getInstance().defencearr[_loc2_].length)
         {
            _loc4_ = int(CScienceReader.getInstance().defencearr[_loc2_][_loc3_].Time);
            this.tip.dj_txt.text = StringManager.getInstance().getMessageString("TechnologyBtn9") + this.mc["mc_base" + _loc2_].tf_page.text;
            if(GamePlayer.getInstance().UserMoney < CScienceReader.getInstance().defencearr[_loc2_][_loc3_].Money && ScienceSystem.getinstance().nowtechid != _loc2_)
            {
               this.tip.mny_txt.text = RegisteredData.getInstance().MoneyDouHao(CScienceReader.getInstance().defencearr[_loc2_][_loc3_].Money) + StringManager.getInstance().getMessageString("TechnologyText0");
               this.tip.mny_txt.setTextFormat(this.ttff);
            }
            else
            {
               this.tip.mny_txt.text = RegisteredData.getInstance().MoneyDouHao(CScienceReader.getInstance().defencearr[_loc2_][_loc3_].Money);
         ...
         {
            _loc4_ = 0;
            this.tip.dj_txt.text = StringManager.getInstance().getMessageString("TechnologyBtn9") + CScienceReader.getInstance().defencearr[_loc2_].length;
         ...
         this.tip.xy_txt.htmlText = RegisteredData.getInstance().GetHtml(String(CScienceReader.getInstance().DefenceTechAry[_loc2_].TechMemo));
         if(this.levelarr[_loc2_] < CScienceReader.getInstance().defencearr[_loc2_].length)
         {
            if(this.levelarr[_loc2_] != 0)
            {
               this.tip.con_txt.htmlText = RegisteredData.getInstance().GetConHtml(String(CScienceReader.getInstance().defencearr[_loc2_][_loc3_ - 1].Comment));
            }
            else
            {
               this.tip.con_txt.htmlText = RegisteredData.getInstance().GetConHtml(String(CScienceReader.getInstance().DefenceTechAry[_loc2_].comment));
            }
            if(ScienceSystem.getinstance().zzsjarr.length == 1)
            {
               if(ScienceSystem.getinstance().zzsjarr[0].CreditFlag == 0 && ScienceSystem.getinstance().zzsjarr[0].tc >= 89 || ScienceSystem.getinstance().zzsjarr[0].tc < 70)
               {
                  if(GamePlayer.getInstance().cash < GamePlayer.getInstance().TechQueueCredit)
                  {
         ...
         BleakingLineForThai.GetInstance().BleakThaiLanguage(this.tip.con_txt);
         BleakingLineForThai.GetInstance().BleakThaiLanguage(this.tip.xy_txt);
         if(_loc8_ == 79)
         {
            this.aa(75);
         }
      ...
      private function LineHd() : void
      {
         ...
         while(_loc1_ < this.xxarr.length)
         {
            ...
            if(_loc2_ == 70 || _loc3_ == 70)
            {
               this.mc["x70_71_80"].gotoAndStop(2);
            }
            if(_loc2_ == 73 || _loc2_ == 76 || _loc2_ == 72)
            {
               this.mc["x72_73_76"].gotoAndStop(2);
            }
            if(_loc2_ == 82 || _loc2_ == 85 || _loc3_ == 82 || _loc3_ == 85)
            {
               this.mc["x81_82_85"].gotoAndStop(2);
            }
            if(_loc2_ == 79 || _loc3_ == 79)
            {
               this.mc["x75_78_79"].gotoAndStop(2);
            }
            if(_loc2_ == 88 || _loc3_ == 88)
            {
               this.mc["x84_87_88"].gotoAndStop(2);
            }
            _loc1_++;
         }
      }
      ...
      private function aa(param1:uint) : void
      {
         ...
         this.carr.length = 0;
         this.darr.length = 0;
         this.barr = String(CScienceReader.getInstance().DefenceTechAry[param1].tech).split(";");
         this.barr.reverse();
         var _loc2_:uint = 0;
