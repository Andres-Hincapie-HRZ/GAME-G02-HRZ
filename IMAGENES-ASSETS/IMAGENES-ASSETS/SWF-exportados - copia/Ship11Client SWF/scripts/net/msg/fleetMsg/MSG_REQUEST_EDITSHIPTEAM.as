package net.msg.fleetMsg
{
   ...
   public class MSG_REQUEST_EDITSHIPTEAM extends MsgHead
   {
      ...
      public function MSG_REQUEST_EDITSHIPTEAM()
      {
         ...
         usType = MsgTypes._MSG_REQUEST_EDITSHIPTEAM;
      }
      ...
      public function writeBuf(param1:ByteArray) : void
      {
         ...
         _loc2_.writeChar(param1,this.EditType);
