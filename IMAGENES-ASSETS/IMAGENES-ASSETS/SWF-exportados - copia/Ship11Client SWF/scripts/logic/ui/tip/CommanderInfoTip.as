      ...
      private function GetDiamondValue() : void
      {
         ...
         while(_loc1_ < 12)
         {
            if(this.CurCommanderInfo.commander_Stone[_loc1_] > -1)
            {
               ...
               {
                  if(_loc2_.GemaValueList["Aim"])
                  {
                     this.commander_aim += int(_loc2_.GemaValueList["Aim"]);
                  }
                  if(_loc2_.GemaValueList["Blench"])
                  {
                     this.commander_blench += int(_loc2_.GemaValueList["Blench"]);
                  }
                  if(_loc2_.GemaValueList["Electron"])
                  {
                     this.commander_electron += int(_loc2_.GemaValueList["Electron"]);
                  }
                  if(_loc2_.GemaValueList["Priority"])
                  {
                     this.commander_priority += int(_loc2_.GemaValueList["Priority"]);
                  }
               }
            }
            _loc1_++;
