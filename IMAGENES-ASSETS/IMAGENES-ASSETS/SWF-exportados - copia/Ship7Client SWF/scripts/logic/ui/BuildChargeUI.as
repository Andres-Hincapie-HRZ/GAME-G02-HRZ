package logic.ui
{
   ...
   public class BuildChargeUI extends AbstractPopUp
   {
      
      private static var instance:BuildChargeUI;
      ...
      public function BuildChargeUI()
      {
         super();
         setPopUpName("BuildChargeUI");
      }
      
      public static function getInstance() : BuildChargeUI
      {
         if(instance == null)
         {
            instance = new BuildChargeUI();
         }
         return instance;
      }
      ...
      override public function Init() : void
      {
         ...
         this._mc = new MObject("BuildchargeMc",0,0);
      ...
      override public function initMcElement() : void
      {
         ...
         {
            if(ScienceSystem.getinstance().levearr[_loc4_][0] >= 89 && ScienceSystem.getinstance().levearr[_loc4_][0] < 97)
            {
      ...
      {
         this.mc["x89_90_91"].gotoAndStop(1);
         this.mc["x89_90"].gotoAndStop(1);
         this.mc["x89_91"].gotoAndStop(1);
         this.mc["x90_91"].gotoAndStop(1);
         this.mc["x90_92"].gotoAndStop(1);
         this.mc["x91_93"].gotoAndStop(1);
         this.mc["x92_93"].gotoAndStop(1);
         this.mc["x92_94"].gotoAndStop(1);
         this.mc["x93_95"].gotoAndStop(1);
         this.mc["x94_95"].gotoAndStop(1);
         this.mc["x95_96"].gotoAndStop(1);
         var _loc1_:uint = 90;
         while(_loc1_ < 97)
         {
      ...
      public function closeHd(param1:uint, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(!param2)
         {
            RegisteredData.getInstance().hs(89,97,this.mc);
            if(param3 == 1)
            {
               return;
            }
      ...
      public function timeHd(param1:uint, param2:uint) : void
      {
         ...
         RegisteredData.getInstance().zsqs(89,97,param1);
      }
      ...
      private function raiHd(param1:MouseEvent) : void
      {
         ...
         {
            if(ScienceSystem.getinstance().zzsjarr[0].tc >= 89 && ScienceSystem.getinstance().zzsjarr[0].tc < 97)
            {
               return;
            }
         }
      ...
      private function ovHd(param1:MouseEvent) : void
      {
         ...
         if(this.levelarr[_loc2_] < CScienceReader.getInstance().defencearr[_loc2_].length)
         {
            ...
            {
               if(ScienceSystem.getinstance().zzsjarr[0].CreditFlag == 0 && ScienceSystem.getinstance().zzsjarr[0].tc >= 97 || ScienceSystem.getinstance().zzsjarr[0].tc < 89)
               {
                  if(GamePlayer.getInstance().cash < GamePlayer.getInstance().TechQueueCredit)
                  {
         ...
         if(_loc8_ == 93 || _loc8_ == 95 || _loc8_ == 96)
         {
            this.aa(91);
            if(_loc8_ == 95 || _loc8_ == 96)
            {
               this.aa(93);
               if(_loc8_ == 96)
               {
      ...
      private function LineHd() : void
      {
         ...
         while(_loc1_ < this.xxarr.length)
         {
            ...
            if(_loc2_ == 89 || _loc3_ == 89)
            {
               this.mc["x89_90_91"].gotoAndStop(2);
            }
            _loc1_++;
         }
      }
