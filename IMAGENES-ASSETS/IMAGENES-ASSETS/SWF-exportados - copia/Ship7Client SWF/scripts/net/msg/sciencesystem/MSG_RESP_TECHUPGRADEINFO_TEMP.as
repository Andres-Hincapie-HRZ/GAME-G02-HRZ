package net.msg.sciencesystem
{
   ...
   public class MSG_RESP_TECHUPGRADEINFO_TEMP
   {
      ...
      public function MSG_RESP_TECHUPGRADEINFO_TEMP()
      {
         super();
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.CreditFlag = _loc2_.readShort(param1);
         _loc2_ = null;
      }
      ...
      public function writeBuf(param1:ByteArray) : void
      {
         ...
         _loc2_.writeShort(param1,this.CreditFlag);
         _loc2_ = null;
      }
