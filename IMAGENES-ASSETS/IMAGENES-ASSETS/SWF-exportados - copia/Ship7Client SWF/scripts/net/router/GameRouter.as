package net.router
{
   ...
   public class GameRouter
   {
      ...
      public function GameRouter(param1:Singleton)
      {
         super();
      }
      ...
      public static function get instance() : GameRouter
      {
         if(_instance == null)
         {
            _instance = new GameRouter(new Singleton());
         }
         return _instance;
      }
      ...
      public function resp_MSG_GAMESERVER_LOGINRESP(param1:int, param2:int, param3:ByteArray) : void
      {
         ...
         var uSize:int = param1;
         var uType:int = param2;
      ...
      {
         if(Boolean(this.taskMc) && this.taskMc.currentFrame == this.taskMc.totalFrames)
         {
