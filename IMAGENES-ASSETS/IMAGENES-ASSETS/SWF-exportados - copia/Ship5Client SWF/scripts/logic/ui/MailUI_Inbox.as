      ...
      public function OnReceiveMail(param1:MSG_RESP_EMAILINFO, param2:Boolean = true) : void
      {
         ...
         while(_loc3_ < this.RowCount)
         {
            ...
            if(_loc3_ < param1.DataLen)
            {
               ...
               if(_loc7_.Type == 1 || _loc7_.Type == 5 || _loc7_.SrcGuid < 0 || _loc7_.TitleType <= 22 && _loc7_.TitleType >= 4 || _loc7_.Type == 4 && _loc7_.TitleType == 0)
               {
                  if(_loc7_.Type == 0 && (_loc7_.Title != "" || _loc7_.TitleType < 12 || _loc7_.TitleType > 21))
                  {
               ...
               if(_loc7_.Title == "" && param2)
               {
                  switch(_loc7_.TitleType)
                  {
                     ...
                     case 19:
                        if(_loc7_.SrcGuid == -1)
                        {
                           _loc7_.Title = StringManager.getInstance().getMessageString("Boss137");
                           break;
                        }
                        if(_loc7_.SrcGuid == 0)
                        {
                           _loc7_.Title = StringManager.getInstance().getMessageString("Boss141");
                           break;
                        }
                        if(_loc7_.SrcGuid == 1)
                        {
                           _loc7_.Title = StringManager.getInstance().getMessageString("Boss139");
                           break;
                        }
                        if(_loc7_.SrcGuid == 2)
                        {
                           _loc7_.Title = StringManager.getInstance().getMessageString("Boss144");
                        }
                        break;
                     case 20:
                        _loc7_.Title = StringManager.getInstance().getMessageString("Boss149");
                        break;
                     case 21:
                        if(_loc7_.SrcGuid == 1)
                        {
                           _loc7_.Title = StringManager.getInstance().getMessageString("Boss159");
                           break;
                        }
                        _loc7_.Title = StringManager.getInstance().getMessageString("Boss169");
                        break;
                     case 22:
                        _loc7_.Title = StringManager.getInstance().getMessageString("Boss180");
                  }
               }
               else if(param2)
               {
