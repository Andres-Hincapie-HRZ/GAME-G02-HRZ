package net.msg.corpsMsg
{
   ...
   public class MSG_REQUEST_INSERTFLAGCONSORTIAIMEMBER extends MsgHead
   {
      ...
      public function MSG_REQUEST_INSERTFLAGCONSORTIAIMEMBER()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_INSERTFLAGCONSORTIAIMEMBER;
      }
