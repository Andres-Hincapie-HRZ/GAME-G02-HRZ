package net.msg.Rank
{
   ...
   public class MSG_RESP_RANKMATCH extends MsgHead
   {
      ...
      public function MSG_RESP_RANKMATCH()
      {
         var _loc2_:MSG_RESP_RANKMATCH_TEMP = null;
         this.Data = new Array(10);
         super();
         var _loc1_:int = 0;
         while(_loc1_ < 10)
         {
            _loc2_ = new MSG_RESP_RANKMATCH_TEMP();
            this.Data[_loc1_] = _loc2_;
            _loc1_++;
         }
         usSize = this.getLength();
         usType = MsgTypes._MSG_RESP_RANKMATCH;
      }
