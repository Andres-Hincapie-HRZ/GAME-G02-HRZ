package net.msg.constructionMsg
{
   ...
   public class MSG_RESP_STORAGERESOURCE extends MsgHead
   {
      ...
      public function MSG_RESP_STORAGERESOURCE()
      {
         ...
         usType = uint(MsgTypes._MSG_RESP_STORAGERESOURCE);
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.Gas = int(_loc2_.readInt(param1));
         this.StorageGas = int(_loc2_.readInt(param1));
         this.Metal = int(_loc2_.readInt(param1));
         this.StorageMetal = int(_loc2_.readInt(param1));
         this.Money = int(_loc2_.readInt(param1));
         this.StorageMoney = int(_loc2_.readInt(param1));
         _loc2_ = null;
      }
