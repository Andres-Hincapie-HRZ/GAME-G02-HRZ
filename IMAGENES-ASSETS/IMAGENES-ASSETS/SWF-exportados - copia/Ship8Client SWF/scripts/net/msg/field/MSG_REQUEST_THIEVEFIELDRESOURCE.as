package net.msg.field
{
   ...
   public class MSG_REQUEST_THIEVEFIELDRESOURCE extends MsgHead
   {
      ...
      public function MSG_REQUEST_THIEVEFIELDRESOURCE()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_THIEVEFIELDRESOURCE;
      }
