package logic.ui
{
   ...
   public class InstanceUI extends AbstractPopUp
   {
      ...
      public function SetLocusFB(param1:int) : void
      {
         ...
         var _loc2_:* = LocusReader.getInstance().LocusCount;
         var _loc4_:int = 0;
         while(_loc4_ < param1)
         {
            if(param1 >= _loc2_)
            ...
            _loc3_ = this._LocusMc.getChildByName("locuslist" + _loc4_) as MovieClip;
            if(_loc3_ == null)
            {
               break;
            }
            _loc3_.gotoAndStop(2);
            this.SetAlpha(_loc3_,_loc4_);
            _loc4_++;
         }
         ...
         var _loc5_:XML = LocusReader.getInstance().GetLocusInfo(param1);
         if(_loc5_ == null)
         {
            return;
         }
         this._LocusFB.EctypeID = _loc5_.@EctypeID;
         this._LocusFB.UserTeam = _loc5_.@UserTeam;
         this.LocusMoney = _loc5_.@Comment;
         this.LocusSP = _loc5_.@Sp;
         _loc3_ = this._LocusMc.getChildByName("locuslist" + param1) as MovieClip;
         _loc3_.gotoAndStop(3);
         this.SetAlpha(_loc3_,param1);
      ...
      public function updateChallengeFBUI() : void
      {
         ...
         {
            _loc2_ = _loc2_.replace("!#",3 + "");
            _loc3_ = _loc3_.replace("!#",1 + "");
         }
         else
         {
            _loc2_ = _loc2_.replace("!#",3 - _loc1_ + "");
            _loc3_ = _loc3_.replace("!#",1 + "");
         }
      ...
      private function InitLocusMc() : void
      {
         ...
         var _loc1_:int = LocusReader.getInstance().LocusCount;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this._LocusMc.getChildByName("locuslist" + _loc2_) as MovieClip;
            _loc4_ = _loc3_.getChildByName("txt_num") as TextField;
            if(_loc4_ != null)
            {
               _loc4_.text = (_loc2_ + 1).toString();
            }
            _loc3_.gotoAndStop(1);
            this.SetAlpha(_loc3_,_loc2_);
            _loc5_ = new XMovieClip(_loc3_);
            _loc5_.Data = _loc2_;
            _loc5_.OnMouseOver = this.GateMouseOver;
            _loc3_.addEventListener(MouseEvent.MOUSE_OUT,this.GateMouseOut);
            _loc2_++;
         }
      ...
      public function startInstance(param1:MouseEvent = null) : void
      {
         ...
         if(_loc4_.ModelType == 1)
         {
            ...
            else if(GamePlayer.getInstance().DefyEctypeNum > 3)
            {
