package logic.ui
{
   ...
   public class OpticsUi extends AbstractPopUp
   {
      
      private static var instance:OpticsUi;
      ...
      public function OpticsUi()
      {
         super();
         setPopUpName("OpticsUi");
      }
      
      public static function getInstance() : OpticsUi
      {
         if(instance == null)
         {
            instance = new OpticsUi();
         }
         return instance;
      }
      ...
      override public function Init() : void
      {
         ...
         this._mc = new MObject("OpticsMc",0,0);
      ...
      override public function initMcElement() : void
      {
         ...
         while(_loc3_ < 64)
         {
            this.levelarr[_loc3_] = 0;
            _loc3_++;
         }
         var _loc4_:uint = 0;
         while(_loc4_ < ScienceSystem.getinstance().levearr.length)
         {
            if(ScienceSystem.getinstance().levearr[_loc4_][0] >= 16 && ScienceSystem.getinstance().levearr[_loc4_][0] < 32)
            {
      ...
      {
         this.mc["x16_17_22"].gotoAndStop(1);
         this.mc["x16_17"].gotoAndStop(1);
         this.mc["x16_22"].gotoAndStop(1);
         this.mc["x17_18"].gotoAndStop(1);
         this.mc["x18_19"].gotoAndStop(1);
         this.mc["x19_20"].gotoAndStop(1);
         this.mc["x20_21"].gotoAndStop(1);
         this.mc["x21_30"].gotoAndStop(1);
         this.mc["x25_26"].gotoAndStop(1);
         this.mc["x26_27"].gotoAndStop(1);
         this.mc["x27_28"].gotoAndStop(1);
         this.mc["x22_25"].gotoAndStop(1);
         this.mc["x22_23"].gotoAndStop(1);
         this.mc["x23_24"].gotoAndStop(1);
         this.mc["x24_28"].gotoAndStop(1);
         this.mc["x24_27_28"].gotoAndStop(1);
         this.mc["x28_29"].gotoAndStop(1);
         this.mc["x29_30"].gotoAndStop(1);
         this.mc["x30_31"].gotoAndStop(1);
         this.mc["x26_18"].gotoAndStop(1);
         var _loc1_:uint = 17;
         while(_loc1_ < 32)
         {
      ...
      public function closeHd(param1:uint, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(!param2)
         {
            RegisteredData.getInstance().hs(16,32,this.mc);
            if(param3 == 1)
            {
               return;
            }
      ...
      public function timeHd(param1:uint, param2:uint) : void
      {
         ...
         RegisteredData.getInstance().zsqs(16,32,param1);
      }
      ...
      private function raiHd(param1:MouseEvent) : void
      {
         ...
         {
            if(ScienceSystem.getinstance().zzsjarr[0].tc >= 16 && ScienceSystem.getinstance().zzsjarr[0].tc < 32)
            {
               return;
            }
         }
      ...
      private function ovHd(param1:MouseEvent) : void
      {
         ...
         if(this.levelarr[_loc2_] < CScienceReader.getInstance().weaponarr[_loc2_].length)
         {
            ...
            {
               if(ScienceSystem.getinstance().zzsjarr[0].CreditFlag == 0 && ScienceSystem.getinstance().zzsjarr[0].tc >= 32 || ScienceSystem.getinstance().zzsjarr[0].tc < 16)
               {
                  if(GamePlayer.getInstance().cash < GamePlayer.getInstance().TechQueueCredit)
                  {
      ...
      private function LineHd() : void
      {
         ...
         while(_loc1_ < this.xxarr.length)
         {
            ...
            if(_loc2_ == 16 || _loc3_ == 16)
            {
               this.mc["x" + 16 + "_" + 17 + "_" + 22].gotoAndStop(2);
            }
            if(_loc2_ == 28 || _loc3_ == 28)
            {
               this.mc["x" + 24 + "_" + 27 + "_" + 28].gotoAndStop(2);
            }
            _loc1_++;
         }
      }
