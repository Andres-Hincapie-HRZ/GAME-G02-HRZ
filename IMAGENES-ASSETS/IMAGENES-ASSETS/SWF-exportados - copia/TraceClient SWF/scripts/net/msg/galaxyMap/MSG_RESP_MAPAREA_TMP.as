package net.msg.galaxyMap
{
   ...
   public class MSG_RESP_MAPAREA_TMP
   {
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.Reserve1 = _loc2_.readInt(param1);
         this.StarFace = _loc2_.readChar(param1);
         this.InsertFlagStatus = _loc2_.readChar(param1);
         this.ConsortiaHeadId = _loc2_.readUnsignChar(param1);
         this.ConsortiaLevelId = _loc2_.readUnsignChar(param1);
         this.Type = _loc2_.readChar(param1);
         if(this.Type == 2)
         {
         }
         this.FightFlag = _loc2_.readChar(param1);
         this.Camp = _loc2_.readChar(param1);
         this.SpaceLevelId = _loc2_.readChar(param1);
         _loc2_ = null;
      }
