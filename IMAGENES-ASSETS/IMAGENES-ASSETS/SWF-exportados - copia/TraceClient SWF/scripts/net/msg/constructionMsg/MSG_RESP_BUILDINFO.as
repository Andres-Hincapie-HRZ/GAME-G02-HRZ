package net.msg.constructionMsg
{
   ...
   public class MSG_RESP_BUILDINFO extends MsgHead
   {
      ...
      public function MSG_RESP_BUILDINFO()
      {
         ...
         usType = MsgTypes._MSG_RESP_BUILDINFO;
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.ConsortiaLeader = _loc2_.readShort(param1);
         this.ViewFlag = _loc2_.readChar(param1);
         this.StarType = _loc2_.readChar(param1);
