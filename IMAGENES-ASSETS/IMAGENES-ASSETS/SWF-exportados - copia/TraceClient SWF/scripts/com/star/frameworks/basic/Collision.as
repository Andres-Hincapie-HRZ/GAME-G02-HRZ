package com.star.frameworks.basic
{
   ...
   public class Collision
   {
      ...
      public static var mIntersection:Rectangle = new Rectangle();
      ...
      public static function CheckCollistion(param1:DisplayObject, param2:DisplayObject, param3:Number = 1) : Boolean
      {
      ...
      public static function complexIntersectionRectangle(param1:DisplayObject, param2:DisplayObject, param3:Number = 1) : Rectangle
      {
         ...
         _loc6_.x += _loc4_.x;
         _loc6_.y += _loc4_.y;
         mIntersection.x = _loc6_.x;
         mIntersection.y = _loc6_.y;
         mIntersection.width = _loc6_.width;
         mIntersection.height = _loc6_.height;
         return _loc6_;
      }
      ...
      protected static function getDrawMatrix(param1:DisplayObject, param2:Rectangle, param3:Number) : Matrix
      {
         ...
         _loc5_ = param1.root.transform.concatenatedMatrix;
