package net.msg
{
   ...
   public class MSG_REQUEST_FROMRESOURCESTARTOHOME extends MsgHead
   {
      ...
      public function MSG_REQUEST_FROMRESOURCESTARTOHOME()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_FROMRESOURCESTARTOHOME;
      }
