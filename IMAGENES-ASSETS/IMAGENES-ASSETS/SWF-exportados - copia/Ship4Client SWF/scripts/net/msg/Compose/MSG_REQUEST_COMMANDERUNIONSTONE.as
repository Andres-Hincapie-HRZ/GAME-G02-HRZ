package net.msg.Compose
{
   ...
   public class MSG_REQUEST_COMMANDERUNIONSTONE extends MsgHead
   {
      ...
      public function MSG_REQUEST_COMMANDERUNIONSTONE()
      {
         super();
         usSize = this.getLength();
         usType = MsgTypes._MSG_REQUEST_COMMANDERUNIONSTONE;
      }
