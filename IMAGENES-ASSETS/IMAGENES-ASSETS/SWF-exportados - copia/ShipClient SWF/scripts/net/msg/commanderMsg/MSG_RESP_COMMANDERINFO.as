package net.msg.commanderMsg
{
   ...
   public class MSG_RESP_COMMANDERINFO extends MsgHead
   {
      ...
      public function MSG_RESP_COMMANDERINFO()
      {
         ...
         usType = uint(uint(MsgTypes._MSG_RESP_COMMANDERINFO));
      }
      ...
      public function readBuf(param1:ByteArray) : void
      {
         ...
         this.CommanderId = int(int(_loc2_.readInt(param1)));
         this.ShipTeamId = int(int(_loc2_.readInt(param1)));
         this.RestTime = int(int(_loc2_.readInt(param1)));
         this.Exp = int(int(_loc2_.readInt(param1)));
         this.Aim = int(int(_loc2_.readShort(param1)));
         this.Blench = int(int(_loc2_.readShort(param1)));
         this.Priority = int(int(_loc2_.readShort(param1)));
         this.Electron = int(int(_loc2_.readShort(param1)));
         this.Skill = int(int(_loc2_.readShort(param1)));
         this.CardLevel = int(int(_loc2_.readShort(param1)));
         this.Level = int(int(_loc2_.readChar(param1)));
         this.Type = int(int(_loc2_.readChar(param1)));
         this.State = int(int(_loc2_.readChar(param1)));
         this.ShowType = int(int(_loc2_.readChar(param1)));
         this.CommanderZJ = _loc2_.readUtf8Str(param1,MsgTypes.COMMANDERZJCOUNT);
         ExternalInterface.call("console.log","[#] FINE 1 ");
         var _loc3_:int = 0;
         ...
         this.Target = int(int(_loc2_.readChar(param1)));
         this.TargetInterval = int(int(_loc2_.readChar(param1)));
         this.Reserve = int(int(_loc2_.readChar(param1)));
         this.AllStatusLen = int(int(_loc2_.readChar(param1)));
         var _loc4_:int = 0;
         ExternalInterface.call("console.log","[#] FINE 3 ");
         ...
         this.StoneHole = int(int(_loc2_.readInt(param1)));
         this.AimPer = int(int(_loc2_.readChar(param1)));
         this.BlenchPer = int(int(_loc2_.readChar(param1)));
         this.PriorityPer = int(int(_loc2_.readChar(param1)));
         this.ElectronPer = int(int(_loc2_.readChar(param1)));
         var _loc6_:int = 0;
