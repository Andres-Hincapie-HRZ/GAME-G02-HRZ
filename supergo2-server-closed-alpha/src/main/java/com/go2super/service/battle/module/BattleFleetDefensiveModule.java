...
public class BattleFleetDefensiveModule extends ShipModule implements Serializable {
    ...
    public double getExplosiveNegation() {
        return getNegation("explosive");
    }

    public double getMagneticNegation() {
        return getNegation("magnetic");
    }

    public double getKineticNegation() {
        return getNegation("kinetic");
    }

    public double getHeatNegation() {
        return getNegation("heat");
    }

    public double getTotalNegation(String addition) {
        return getDamageNegate() +
               getNegation(addition);
    }

    public double getTotalNegation() {
        return getDamageNegate() +
               getExplosiveNegation() +
               getMagneticNegation() +
               getKineticNegation() +
               getHeatNegation();
    }

    public double getNegation(String type) {
