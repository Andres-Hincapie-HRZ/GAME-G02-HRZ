...
public class AddCommand extends Command {
    ...
    public void execute(User user, Account account, SmartServer smartServer, String label, String[] parts) {
        ...
        Long gold = Math.abs(user.getResources().getGold() - 900_000_000);
        Long he3 = Math.abs(user.getResources().getHe3() - 900_000_000);
        Long metal = Math.abs(user.getResources().getMetal() - 900_000_000);
        ...
        user.getResources().setGold(900_000_000);
        user.getResources().setHe3(900_000_000);
        user.getResources().setMetal(900_000_000);
