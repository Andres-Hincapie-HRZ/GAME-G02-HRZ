...
public class TempBanCommand extends Command {
    ...
    public void execute(User user, Account account, SmartServer smartServer, String label, String[] parts) {
        ...
        if(parts.length < 3) {
            ...
            sendMessage("Command 'tempban' need more arguments! (example: /tempban 1 1m scam)", user);
            return;
        ...
        ChatService.getInstance().medusaMessage("The user [" + toUser.getUsername() + "] has been banned for " + (parsed / 1000) + " seconds!");
