...
public class Lookup {
    ...
    public static UserCommanderLookup getUserCommanders(User user) {
        ...
        for(Commander commander : commanders) userCommanderLookup.getCommanders().add(getCommander(commander));
    ...
    public static CommanderLookup getCommander(Commander commander) {
        ...
        for(BionicChip bionicChip : commander.getChips()) {
            ...
            if(propData != null) chipLookup.setChipName(propData.getName());
        ...
        for(Integer gem : commander.getGems()) {
            ...
            if(propData != null) gemLookup.setGemName(propData.getName());
