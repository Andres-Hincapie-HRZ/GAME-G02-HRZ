...
// Anotación que indica que esta clase es un documento MongoDB en la colección "game_risk_incidents"
...
// Clase que representa un incidente de riesgo en el juego
public class RiskIncident {

    // Campo ID único de MongoDB
    @Id // Anotación JPA para ID
    private ObjectId id; // ID único del incidente de riesgo

    // Campos de información del incidente
    private boolean ignore; // Si el incidente debe ser ignorado
    private Date creation; // Fecha de creación del incidente
    private String creator; // Creador del incidente
